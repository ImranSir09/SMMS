import{F as om,L as am,t as ie,u as It,v as Zo,w as Fl,x as cs,y as um,n as cm,e as Ol,z as lm,k as hm,A as dm,B as fm,C as si,E as Ll,G as ql,g as mm,j as gm,H as pm,r as cc,S as _m}from"./index.esm-Bz5Ej7vO.js";var lc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let sr="12.12.0";function ym(r){sr=r}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new am("@firebase/firestore");function xn(){return Ce.logLevel}function Ey(r){Ce.setLogLevel(r)}function x(r,...t){if(Ce.logLevel<=ie.DEBUG){const e=t.map(ta);Ce.debug(`Firestore (${sr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ie.ERROR){const e=t.map(ta);Ce.error(`Firestore (${sr}): ${r}`,...e)}}function Gt(r,...t){if(Ce.logLevel<=ie.WARN){const e=t.map(ta);Ce.warn(`Firestore (${sr}): ${r}`,...e)}}function ta(r){if(typeof r=="string")return r;try{return(function(e){return JSON.stringify(e)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(r,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,$l(r,n,e)}function $l(r,t,e){let n=`FIRESTORE (${sr}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw mt(n),new Error(n)}function L(r,t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,r||$l(t,s,n)}function wy(r,t){r||O(57014,t)}function M(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ql{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Im{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(At.UNAUTHENTICATED)))}shutdown(){}}class Tm{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable((()=>e(this.token.user)))}shutdown(){this.changeListener=null}}class Em{constructor(t){this.t=t,this.currentUser=At.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){L(this.o===void 0,42304);let n=this.i;const s=c=>this.i!==n?(n=this.i,e(c)):Promise.resolve();let i=new Rt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Rt,t.enqueueRetryable((()=>s(this.currentUser)))};const a=()=>{const c=i;t.enqueueRetryable((async()=>{await c.promise,await s(this.currentUser)}))},u=c=>{x("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((c=>u(c))),setTimeout((()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?u(c):(x("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Rt)}}),0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then((n=>this.i!==t?(x("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(L(typeof n.accessToken=="string",31837,{l:n}),new Ql(n.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return L(t===null||typeof t=="string",2055,{h:t}),new At(t)}}class wm{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=At.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const t=this.A();return t&&this.R.set("Authorization",t),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class Am{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new wm(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable((()=>e(At.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class So{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class vm{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,mm(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){L(this.o===void 0,3512);const n=i=>{i.error!=null&&x("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,x("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(i.token):Promise.resolve()};this.o=i=>{t.enqueueRetryable((()=>n(i)))};const s=i=>{x("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((i=>s(i))),setTimeout((()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):x("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new So(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then((e=>e?(L(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new So(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}class Ay{getToken(){return Promise.resolve(new So(""))}invalidateToken(){}start(t,e){}shutdown(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ea{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const s=Rm(40);for(let i=0;i<s.length;++i)n.length<20&&s[i]<e&&(n+=t.charAt(s[i]%62))}return n}}function z(r,t){return r<t?-1:r>t?1:0}function Vo(r,t){const e=Math.min(r.length,t.length);for(let n=0;n<e;n++){const s=r.charAt(n),i=t.charAt(n);if(s!==i)return _o(s)===_o(i)?z(s,i):_o(s)?1:-1}return z(r.length,t.length)}const Pm=55296,Sm=57343;function _o(r){const t=r.charCodeAt(0);return t>=Pm&&t<=Sm}function Ln(r,t,e){return r.length===t.length&&r.every(((n,s)=>e(n,t[s])))}function Wl(r){return r+"\0"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye="remoteDocuments",hs="owner",Rn="owner",Yr="mutationQueues",Om="userId",Qt="mutations",_c="batchId",nn="userMutationsIndex",yc=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(r,t){return[r,xt(t)]}function rh(r,t,e){return[r,xt(t),e]}const Lm={},jn="documentMutations",oi="remoteDocumentsV14",qm=["prefixPath","collectionGroup","readTime","documentId"],Hs="documentKeyIndex",Bm=["prefixPath","collectionGroup","documentId"],sh="collectionGroupIndex",Um=["collectionGroup","readTime","prefixPath","documentId"],Xr="remoteDocumentGlobal",xo="remoteDocumentGlobalKey",zn="targets",ih="queryTargetsIndex",jm=["canonicalId","targetId"],Gn="targetDocuments",zm=["targetId","path"],ia="documentTargetsIndex",Gm=["path","targetId"],ai="targetGlobalKey",sn="targetGlobal",Zr="collectionParents",Km=["collectionId","parent"],Kn="clientMetadata",$m="clientId",wi="bundles",Qm="bundleId",Ai="namedQueries",Wm="name",oa="indexConfiguration",Hm="indexId",Do="collectionGroupIndex",Jm="collectionGroup",zr="indexState",Ym=["indexId","uid"],oh="sequenceNumberIndex",Xm=["uid","sequenceNumber"],Gr="indexEntries",Zm=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],ah="documentKeyIndex",tg=["indexId","uid","orderedDocumentKey"],vi="documentOverlays",eg=["userId","collectionPath","documentId"],No="collectionPathOverlayIndex",ng=["userId","collectionPath","largestBatchId"],uh="collectionGroupOverlayIndex",rg=["userId","collectionGroup","largestBatchId"],aa="globals",sg="name",ch=[Yr,Qt,jn,Ye,zn,hs,sn,Gn,Kn,Xr,Zr,wi,Ai],ig=[...ch,vi],lh=[Yr,Qt,jn,oi,zn,hs,sn,Gn,Kn,Xr,Zr,wi,Ai,vi],hh=lh,ua=[...hh,oa,zr,Gr],og=ua,dh=[...ua,aa],ag=dh;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko extends th{constructor(t,e){super(),this.le=t,this.currentSequenceNumber=e}}function Tt(r,t){const e=M(r);return te.O(e.le,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(t,e="asc"){this.field=t,this.dir=e}}function fg(r,t){return r.dir===t.dir&&r.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tg{constructor(t,e=null,n=[],s=[],i=null,a=null,u=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=a,this.endAt=u,this.Te=null}}function qo(r,t=null,e=[],n=[],s=null,i=null,a=null){return new Tg(r,t,e,n,s,i,a)}function cn(r){const t=M(r);if(t.Te===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map((n=>Lo(n))).join(","),e+="|ob:",e+=t.orderBy.map((n=>(function(i){return i.field.canonicalString()+i.dir})(n))).join(","),ls(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map((n=>Qn(n))).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map((n=>Qn(n))).join(",")),t.Te=e}return t.Te}function ds(r,t){if(r.limit!==t.limit||r.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<r.orderBy.length;e++)if(!fg(r.orderBy[e],t.orderBy[e]))return!1;if(r.filters.length!==t.filters.length)return!1;for(let e=0;e<r.filters.length;e++)if(!Ph(r.filters[e],t.filters[e]))return!1;return r.collectionGroup===t.collectionGroup&&!!r.path.isEqual(t.path)&&!!Vc(r.startAt,t.startAt)&&Vc(r.endAt,t.endAt)}function ui(r){return k.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function ci(r,t){return r.filters.filter((e=>e instanceof W&&e.field.isEqual(t)))}function bc(r,t,e){let n=Js,s=!0;for(const i of ci(r,t)){let a=Js,u=!0;switch(i.op){case"<":case"<=":a=hg(i.value);break;case"==":case"in":case">=":a=i.value;break;case">":a=i.value,u=!1;break;case"!=":case"not-in":a=Js}Rc({value:n,inclusive:s},{value:a,inclusive:u})<0&&(n=a,s=u)}if(e!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(t)){const a=e.position[i];Rc({value:n,inclusive:s},{value:a,inclusive:e.inclusive})<0&&(n=a,s=e.inclusive);break}}return{value:n,inclusive:s}}function Cc(r,t,e){let n=Re,s=!0;for(const i of ci(r,t)){let a=Re,u=!0;switch(i.op){case">=":case">":a=dg(i.value),u=!1;break;case"==":case"in":case"<=":a=i.value;break;case"<":a=i.value,u=!1;break;case"!=":case"not-in":a=Re}Pc({value:n,inclusive:s},{value:a,inclusive:u})>0&&(n=a,s=u)}if(e!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(t)){const a=e.position[i];Pc({value:n,inclusive:s},{value:a,inclusive:e.inclusive})>0&&(n=a,s=e.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pg=new it(k.comparator);function Lt(){return Pg}const Oh=new it(k.comparator);function Lr(...r){let t=Oh;for(const e of r)t=t.insert(e.key,e);return t}function Lh(r){let t=Oh;return r.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function Zt(){return $r()}function qh(){return $r()}function $r(){return new he((r=>r.toString()),((r,t)=>r.isEqual(t)))}const Sg=new it(k.comparator),Vg=new et(k.comparator);function G(...r){let t=Vg;for(const e of r)t=t.add(e);return t}const bg=new et(z);function fa(){return bg}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wr=null;function Og(r){if(Wr)throw new Error("a TestingHooksSpi instance is already set");Wr=r}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ep{bt(t){return Tt(t,aa)}getSessionToken(t){return this.bt(t).get("sessionToken").next((e=>{const n=e==null?void 0:e.value;return n?ft.fromUint8Array(n):ft.EMPTY_BYTE_STRING}))}setSessionToken(t,e){return this.bt(t).put({name:"sessionToken",value:e.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn=255;function np(r){if(r===0)return 8;let t=0;return r>>4||(t+=4,r<<=4),r>>6||(t+=2,r<<=2),r>>7||(t+=1),t}function $c(r){const t=64-(function(n){let s=0;for(let i=0;i<8;++i){const a=np(255&n[i]);if(s+=a,a!==8)break}return s})(r);return Math.ceil(t/8)}class rp{constructor(){this.buffer=new Uint8Array(1024),this.position=0}Qt(t){const e=t[Symbol.iterator]();let n=e.next();for(;!n.done;)this.Gt(n.value),n=e.next();this.zt()}jt(t){const e=t[Symbol.iterator]();let n=e.next();for(;!n.done;)this.Jt(n.value),n=e.next();this.Ht()}Zt(t){for(const e of t){const n=e.charCodeAt(0);if(n<128)this.Gt(n);else if(n<2048)this.Gt(960|n>>>6),this.Gt(128|63&n);else if(e<"\uD800"||"\uDBFF"<e)this.Gt(480|n>>>12),this.Gt(128|63&n>>>6),this.Gt(128|63&n);else{const s=e.codePointAt(0);this.Gt(240|s>>>18),this.Gt(128|63&s>>>12),this.Gt(128|63&s>>>6),this.Gt(128|63&s)}}this.zt()}Xt(t){for(const e of t){const n=e.charCodeAt(0);if(n<128)this.Jt(n);else if(n<2048)this.Jt(960|n>>>6),this.Jt(128|63&n);else if(e<"\uD800"||"\uDBFF"<e)this.Jt(480|n>>>12),this.Jt(128|63&n>>>6),this.Jt(128|63&n);else{const s=e.codePointAt(0);this.Jt(240|s>>>18),this.Jt(128|63&s>>>12),this.Jt(128|63&s>>>6),this.Jt(128|63&s)}}this.Ht()}Yt(t){const e=this.en(t),n=$c(e);this.tn(1+n),this.buffer[this.position++]=255&n;for(let s=e.length-n;s<e.length;++s)this.buffer[this.position++]=255&e[s]}nn(t){const e=this.en(t),n=$c(e);this.tn(1+n),this.buffer[this.position++]=~(255&n);for(let s=e.length-n;s<e.length;++s)this.buffer[this.position++]=~(255&e[s])}rn(){this.sn(Sn),this.sn(255)}_n(){this.an(Sn),this.an(255)}reset(){this.position=0}seed(t){this.tn(t.length),this.buffer.set(t,this.position),this.position+=t.length}un(){return this.buffer.slice(0,this.position)}en(t){const e=(function(i){const a=new DataView(new ArrayBuffer(8));return a.setFloat64(0,i,!1),new Uint8Array(a.buffer)})(t),n=!!(128&e[0]);e[0]^=n?255:128;for(let s=1;s<e.length;++s)e[s]^=n?255:0;return e}Gt(t){const e=255&t;e===0?(this.sn(0),this.sn(255)):e===Sn?(this.sn(Sn),this.sn(0)):this.sn(e)}Jt(t){const e=255&t;e===0?(this.an(0),this.an(255)):e===Sn?(this.an(Sn),this.an(0)):this.an(t)}zt(){this.sn(0),this.sn(1)}Ht(){this.an(0),this.an(1)}sn(t){this.tn(1),this.buffer[this.position++]=t}an(t){this.tn(1),this.buffer[this.position++]=~t}tn(t){const e=t+this.position;if(e<=this.buffer.length)return;let n=2*this.buffer.length;n<e&&(n=e);const s=new Uint8Array(n);s.set(this.buffer),this.buffer=s}}class sp{constructor(t){this.cn=t}Bt(t){this.cn.Qt(t)}xt(t){this.cn.Zt(t)}Mt(t){this.cn.Yt(t)}vt(){this.cn.rn()}}class ip{constructor(t){this.cn=t}Bt(t){this.cn.jt(t)}xt(t){this.cn.Xt(t)}Mt(t){this.cn.nn(t)}vt(){this.cn._n()}}class Dr{constructor(){this.cn=new rp,this.ascending=new sp(this.cn),this.descending=new ip(this.cn)}seed(t){this.cn.seed(t)}ln(t){return t===0?this.ascending:this.descending}un(){return this.cn.un()}reset(){this.cn.reset()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc="IndexedDbIndexManager",js=new Uint8Array(0);class up{constructor(t,e){this.databaseId=e,this.Dn=new wa,this.Cn=new he((n=>cn(n)),((n,s)=>ds(n,s))),this.uid=t.uid||""}addToCollectionParentIndex(t,e){if(!this.Dn.has(e)){const n=e.lastSegment(),s=e.popLast();t.addOnCommittedListener((()=>{this.Dn.add(e)}));const i={collectionId:n,parent:xt(s)};return Xc(t).put(i)}return A.resolve()}getCollectionParents(t,e){const n=[],s=IDBKeyRange.bound([e,""],[Wl(e),""],!1,!0);return Xc(t).J(s).next((i=>{for(const a of i){if(a.collectionId!==e)break;n.push(Xt(a.parent))}return n}))}addFieldIndex(t,e){const n=Nr(t),s=(function(u){return{indexId:u.indexId,collectionGroup:u.collectionGroup,fields:u.fields.map((c=>[c.fieldPath.canonicalString(),c.kind]))}})(e);delete s.indexId;const i=n.add(s);if(e.indexState){const a=bn(t);return i.next((u=>{a.put(zc(u,this.uid,e.indexState.sequenceNumber,e.indexState.offset))}))}return i.next()}deleteFieldIndex(t,e){const n=Nr(t),s=bn(t),i=Vn(t);return n.delete(e.indexId).next((()=>s.delete(IDBKeyRange.bound([e.indexId],[e.indexId+1],!1,!0)))).next((()=>i.delete(IDBKeyRange.bound([e.indexId],[e.indexId+1],!1,!0))))}deleteAllFieldIndexes(t){const e=Nr(t),n=Vn(t),s=bn(t);return e.X().next((()=>n.X())).next((()=>s.X()))}createTargetIndexes(t,e){return A.forEach(this.vn(e),(n=>this.getIndexType(t,n).next((s=>{if(s===0||s===1){const i=new Hc(n).Sn();if(i!=null)return this.addFieldIndex(t,i)}}))))}getDocumentsMatchingTarget(t,e){const n=Vn(t);let s=!0;const i=new Map;return A.forEach(this.vn(e),(a=>this.Fn(t,a).next((u=>{s&&(s=!!u),i.set(a,u)})))).next((()=>{if(s){let a=G();const u=[];return A.forEach(i,((c,h)=>{x(Yc,`Using index ${(function(U){return`id=${U.indexId}|cg=${U.collectionGroup}|f=${U.fields.map((X=>`${X.fieldPath}:${X.kind}`)).join(",")}`})(c)} to execute ${cn(e)}`);const f=(function(U,X){const J=Co(X);if(J===void 0)return null;for(const Y of ci(U,J.fieldPath))switch(Y.op){case"array-contains-any":return Y.value.arrayValue.values||[];case"array-contains":return[Y.value]}return null})(h,c),m=(function(U,X){const J=new Map;for(const Y of Je(X))for(const T of ci(U,Y.fieldPath))switch(T.op){case"==":case"in":J.set(Y.fieldPath.canonicalString(),T.value);break;case"not-in":case"!=":return J.set(Y.fieldPath.canonicalString(),T.value),Array.from(J.values())}return null})(h,c),p=(function(U,X){const J=[];let Y=!0;for(const T of Je(X)){const _=T.kind===0?bc(U,T.fieldPath,U.startAt):Cc(U,T.fieldPath,U.startAt);J.push(_.value),Y&&(Y=_.inclusive)}return new Ne(J,Y)})(h,c),v=(function(U,X){const J=[];let Y=!0;for(const T of Je(X)){const _=T.kind===0?Cc(U,T.fieldPath,U.endAt):bc(U,T.fieldPath,U.endAt);J.push(_.value),Y&&(Y=_.inclusive)}return new Ne(J,Y)})(h,c),C=this.Mn(c,h,p),N=this.Mn(c,h,v),D=this.xn(c,h,m),q=this.On(c.indexId,f,C,p.inclusive,N,v.inclusive,D);return A.forEach(q,(j=>n.Z(j,e.limit).next((U=>{U.forEach((X=>{const J=k.fromSegments(X.documentKey);a.has(J)||(a=a.add(J),u.push(J))}))}))))})).next((()=>u))}return A.resolve(null)}))}vn(t){let e=this.Cn.get(t);return e||(t.filters.length===0?e=[t]:e=op(tt.create(t.filters,"and")).map((n=>qo(t.path,t.collectionGroup,t.orderBy,n.getFilters(),t.limit,t.startAt,t.endAt))),this.Cn.set(t,e),e)}On(t,e,n,s,i,a,u){const c=(e!=null?e.length:1)*Math.max(n.length,i.length),h=c/(e!=null?e.length:1),f=[];for(let m=0;m<c;++m){const p=e?this.Nn(e[m/h]):js,v=this.Bn(t,p,n[m%h],s),C=this.Ln(t,p,i[m%h],a),N=u.map((D=>this.Bn(t,p,D,!0)));f.push(...this.createRange(v,C,N))}return f}Bn(t,e,n,s){const i=new en(t,k.empty(),e,n);return s?i:i.In()}Ln(t,e,n,s){const i=new en(t,k.empty(),e,n);return s?i.In():i}Fn(t,e){const n=new Hc(e),s=e.collectionGroup!=null?e.collectionGroup:e.path.lastSegment();return this.getFieldIndexes(t,s).next((i=>{let a=null;for(const u of i)n.gn(u)&&(!a||u.fields.length>a.fields.length)&&(a=u);return a}))}getIndexType(t,e){let n=2;const s=this.vn(e);return A.forEach(s,(i=>this.Fn(t,i).next((a=>{a?n!==0&&a.fields.length<(function(c){let h=new et(ct.comparator),f=!1;for(const m of c.filters)for(const p of m.getFlattenedFilters())p.field.isKeyField()||(p.op==="array-contains"||p.op==="array-contains-any"?f=!0:h=h.add(p.field));for(const m of c.orderBy)m.field.isKeyField()||(h=h.add(m.field));return h.size+(f?1:0)})(i)&&(n=1):n=0})))).next((()=>(function(a){return a.limit!==null})(e)&&s.length>1&&n===2?1:n))}kn(t,e){const n=new Dr;for(const s of Je(t)){const i=e.data.field(s.fieldPath);if(i==null)return null;const a=n.ln(s.kind);tn.Wt.Dt(i,a)}return n.un()}Nn(t){const e=new Dr;return tn.Wt.Dt(t,e.ln(0)),e.un()}qn(t,e){const n=new Dr;return tn.Wt.Dt(un(this.databaseId,e),n.ln((function(i){const a=Je(i);return a.length===0?0:a[a.length-1].kind})(t))),n.un()}xn(t,e,n){if(n===null)return[];let s=[];s.push(new Dr);let i=0;for(const a of Je(t)){const u=n[i++];for(const c of s)if(this.Kn(e,a.fieldPath)&&rs(u))s=this.Un(s,a,u);else{const h=c.ln(a.kind);tn.Wt.Dt(u,h)}}return this.$n(s)}Mn(t,e,n){return this.xn(t,e,n.position)}$n(t){const e=[];for(let n=0;n<t.length;++n)e[n]=t[n].un();return e}Un(t,e,n){const s=[...t],i=[];for(const a of n.arrayValue.values||[])for(const u of s){const c=new Dr;c.seed(u.un()),tn.Wt.Dt(a,c.ln(e.kind)),i.push(c)}return i}Kn(t,e){return!!t.filters.find((n=>n instanceof W&&n.field.isEqual(e)&&(n.op==="in"||n.op==="not-in")))}getFieldIndexes(t,e){const n=Nr(t),s=bn(t);return(e?n.J(Do,IDBKeyRange.bound(e,e)):n.J()).next((i=>{const a=[];return A.forEach(i,(u=>s.get([u.indexId,this.uid]).next((c=>{a.push((function(f,m){const p=m?new Un(m.sequenceNumber,new Kt(fn(m.readTime),new k(Xt(m.documentKey)),m.largestBatchId)):Un.empty(),v=f.fields.map((([C,N])=>new rn(ct.fromServerFormat(C),N)));return new Bn(f.indexId,f.collectionGroup,v,p)})(u,c))})))).next((()=>a))}))}getNextCollectionGroupToUpdate(t){return this.getFieldIndexes(t).next((e=>e.length===0?null:(e.sort(((n,s)=>{const i=n.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:z(n.collectionGroup,s.collectionGroup)})),e[0].collectionGroup)))}updateCollectionGroup(t,e,n){const s=Nr(t),i=bn(t);return this.Wn(t).next((a=>s.J(Do,IDBKeyRange.bound(e,e)).next((u=>A.forEach(u,(c=>i.put(zc(c.indexId,this.uid,a,n))))))))}updateIndexEntries(t,e){const n=new Map;return A.forEach(e,((s,i)=>{const a=n.get(s.collectionGroup);return(a?A.resolve(a):this.getFieldIndexes(t,s.collectionGroup)).next((u=>(n.set(s.collectionGroup,u),A.forEach(u,(c=>this.Qn(t,s,c).next((h=>{const f=this.Gn(i,c);return h.isEqual(f)?A.resolve():this.zn(t,i,c,h,f)})))))))}))}jn(t,e,n,s){return Vn(t).put(s.Rn(this.uid,this.qn(n,e.key),e.key))}Jn(t,e,n,s){return Vn(t).delete(s.An(this.uid,this.qn(n,e.key),e.key))}Qn(t,e,n){const s=Vn(t);let i=new et(Te);return s.ee({index:ah,range:IDBKeyRange.only([n.indexId,this.uid,ei(this.qn(n,e))])},((a,u)=>{i=i.add(new en(n.indexId,e,Wc(u.arrayValue),Wc(u.directionalValue)))})).next((()=>i))}Gn(t,e){let n=new et(Te);const s=this.kn(e,t);if(s==null)return n;const i=Co(e);if(i!=null){const a=t.data.field(i.fieldPath);if(rs(a))for(const u of a.arrayValue.values||[])n=n.add(new en(e.indexId,t.key,this.Nn(u),s))}else n=n.add(new en(e.indexId,t.key,js,s));return n}zn(t,e,n,s,i){x(Yc,"Updating index entries for document '%s'",e.key);const a=[];return(function(c,h,f,m,p){const v=c.getIterator(),C=h.getIterator();let N=Pn(v),D=Pn(C);for(;N||D;){let q=!1,j=!1;if(N&&D){const U=f(N,D);U<0?j=!0:U>0&&(q=!0)}else N!=null?j=!0:q=!0;q?(m(D),D=Pn(C)):j?(p(N),N=Pn(v)):(N=Pn(v),D=Pn(C))}})(s,i,Te,(u=>{a.push(this.jn(t,e,n,u))}),(u=>{a.push(this.Jn(t,e,n,u))})),A.waitFor(a)}Wn(t){let e=1;return bn(t).ee({index:oh,reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},((n,s,i)=>{i.done(),e=s.sequenceNumber+1})).next((()=>e))}createRange(t,e,n){n=n.sort(((a,u)=>Te(a,u))).filter(((a,u,c)=>!u||Te(a,c[u-1])!==0));const s=[];s.push(t);for(const a of n){const u=Te(a,t),c=Te(a,e);if(u===0)s[0]=t.In();else if(u>0&&c<0)s.push(a),s.push(a.In());else if(c>0)break}s.push(e);const i=[];for(let a=0;a<s.length;a+=2){if(this.Hn(s[a],s[a+1]))return[];const u=s[a].An(this.uid,js,k.empty()),c=s[a+1].An(this.uid,js,k.empty());i.push(IDBKeyRange.bound(u,c))}return i}Hn(t,e){return Te(t,e)>0}getMinOffsetFromCollectionGroup(t,e){return this.getFieldIndexes(t,e).next(Zc)}getMinOffset(t,e){return A.mapArray(this.vn(e),(n=>this.Fn(t,n).next((s=>s||O(44426))))).next(Zc)}}function Xc(r){return Tt(r,Zr)}function Vn(r){return Tt(r,Gr)}function Nr(r){return Tt(r,oa)}function bn(r){return Tt(r,zr)}function Zc(r){L(r.length!==0,28825);let t=r[0].indexState.offset,e=t.largestBatchId;for(let n=1;n<r.length;n++){const s=r[n].indexState.offset;ra(s,t)<0&&(t=s),e<s.largestBatchId&&(e=s.largestBatchId)}return new Kt(t.readTime,t.documentKey,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fp{constructor(t){this.serializer=t}setIndexManager(t){this.indexManager=t}addEntry(t,e,n){return He(t).put(n)}removeEntry(t,e,n){return He(t).delete((function(i,a){const u=i.path.toArray();return[u.slice(0,u.length-2),u[u.length-2],hi(a),u[u.length-1]]})(e,n))}updateMetadata(t,e){return this.getMetadata(t).next((n=>(n.byteSize+=e,this.Sr(t,n))))}getEntry(t,e){let n=at.newInvalidDocument(e);return He(t).ee({index:Hs,range:IDBKeyRange.only(kr(e))},((s,i)=>{n=this.br(e,i)})).next((()=>n))}Dr(t,e){let n={size:0,document:at.newInvalidDocument(e)};return He(t).ee({index:Hs,range:IDBKeyRange.only(kr(e))},((s,i)=>{n={document:this.br(e,i),size:fi(i)}})).next((()=>n))}getEntries(t,e){let n=Lt();return this.Cr(t,e,((s,i)=>{const a=this.br(s,i);n=n.insert(s,a)})).next((()=>n))}vr(t,e){let n=Lt(),s=new it(k.comparator);return this.Cr(t,e,((i,a)=>{const u=this.br(i,a);n=n.insert(i,u),s=s.insert(i,fi(a))})).next((()=>({documents:n,Fr:s})))}Cr(t,e,n){if(e.isEmpty())return A.resolve();let s=new et(ol);e.forEach((c=>s=s.add(c)));const i=IDBKeyRange.bound(kr(s.first()),kr(s.last())),a=s.getIterator();let u=a.getNext();return He(t).ee({index:Hs,range:i},((c,h,f)=>{const m=k.fromSegments([...h.prefixPath,h.collectionGroup,h.documentId]);for(;u&&ol(u,m)<0;)n(u,null),u=a.getNext();u&&u.isEqual(m)&&(n(u,h),u=a.hasNext()?a.getNext():null),u?f.j(kr(u)):f.done()})).next((()=>{for(;u;)n(u,null),u=a.hasNext()?a.getNext():null}))}getDocumentsMatchingQuery(t,e,n,s,i){const a=e.path,u=[a.popLast().toArray(),a.lastSegment(),hi(n.readTime),n.documentKey.path.isEmpty()?"":n.documentKey.path.lastSegment()],c=[a.popLast().toArray(),a.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return He(t).J(IDBKeyRange.bound(u,c,!0)).next((h=>{i==null||i.incrementDocumentReadCount(h.length);let f=Lt();for(const m of h){const p=this.br(k.fromSegments(m.prefixPath.concat(m.collectionGroup,m.documentId)),m);p.isFoundDocument()&&(ms(e,p)||s.has(p.key))&&(f=f.insert(p.key,p))}return f}))}getAllFromCollectionGroup(t,e,n,s){let i=Lt();const a=il(e,n),u=il(e,Kt.max());return He(t).ee({index:sh,range:IDBKeyRange.bound(a,u,!0)},((c,h,f)=>{const m=this.br(k.fromSegments(h.prefixPath.concat(h.collectionGroup,h.documentId)),h);i=i.insert(m.key,m),i.size===s&&f.done()})).next((()=>i))}newChangeBuffer(t){return new mp(this,!!t&&t.trackRemovals)}getSize(t){return this.getMetadata(t).next((e=>e.byteSize))}getMetadata(t){return sl(t).get(xo).next((e=>(L(!!e,20021),e)))}Sr(t,e){return sl(t).put(xo,e)}br(t,e){if(e){const n=Zg(this.serializer,e);if(!(n.isNoDocument()&&n.version.isEqual(B.min())))return n}return at.newInvalidDocument(t)}}function vd(r){return new fp(r)}class mp extends Ad{constructor(t,e){super(),this.Mr=t,this.trackRemovals=e,this.Or=new he((n=>n.toString()),((n,s)=>n.isEqual(s)))}applyChanges(t){const e=[];let n=0,s=new et(((i,a)=>z(i.canonicalString(),a.canonicalString())));return this.changes.forEach(((i,a)=>{const u=this.Or.get(i);if(e.push(this.Mr.removeEntry(t,i,u.readTime)),a.isValidDocument()){const c=Uc(this.Mr.serializer,a);s=s.add(i.path.popLast());const h=fi(c);n+=h-u.size,e.push(this.Mr.addEntry(t,i,c))}else if(n-=u.size,this.trackRemovals){const c=Uc(this.Mr.serializer,a.convertToNoDocument(B.min()));e.push(this.Mr.addEntry(t,i,c))}})),s.forEach((i=>{e.push(this.Mr.indexManager.addToCollectionParentIndex(t,i))})),e.push(this.Mr.updateMetadata(t,n)),A.waitFor(e)}getFromCache(t,e){return this.Mr.Dr(t,e).next((n=>(this.Or.set(e,{size:n.size,readTime:n.document.readTime}),n.document)))}getAllFromCache(t,e){return this.Mr.vr(t,e).next((({documents:n,Fr:s})=>(s.forEach(((i,a)=>{this.Or.set(i,{size:a,readTime:n.get(i).readTime})})),n)))}}function sl(r){return Tt(r,Xr)}function He(r){return Tt(r,oi)}function kr(r){const t=r.path.toArray();return[t.slice(0,t.length-2),t[t.length-2],t[t.length-1]]}function il(r,t){const e=t.documentKey.path.toArray();return[r,hi(t.readTime),e.slice(0,e.length-2),e.length>0?e[e.length-1]:""]}function ol(r,t){const e=r.path.toArray(),n=t.path.toArray();let s=0;for(let i=0;i<e.length-2&&i<n.length-2;++i)if(s=z(e[i],n[i]),s)return s;return s=z(e.length,n.length),s||(s=z(e[e.length-2],n[n.length-2]),s||z(e[e.length-1],n[n.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yp{constructor(){this.sessionToken=ft.EMPTY_BYTE_STRING}getSessionToken(t){return A.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,A.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aa{constructor(){this.kr=new et(wt.qr),this.Kr=new et(wt.Ur)}isEmpty(){return this.kr.isEmpty()}addReference(t,e){const n=new wt(t,e);this.kr=this.kr.add(n),this.Kr=this.Kr.add(n)}$r(t,e){t.forEach((n=>this.addReference(n,e)))}removeReference(t,e){this.Wr(new wt(t,e))}Qr(t,e){t.forEach((n=>this.removeReference(n,e)))}Gr(t){const e=new k(new $([])),n=new wt(e,t),s=new wt(e,t+1),i=[];return this.Kr.forEachInRange([n,s],(a=>{this.Wr(a),i.push(a.key)})),i}zr(){this.kr.forEach((t=>this.Wr(t)))}Wr(t){this.kr=this.kr.delete(t),this.Kr=this.Kr.delete(t)}jr(t){const e=new k(new $([])),n=new wt(e,t),s=new wt(e,t+1);let i=G();return this.Kr.forEachInRange([n,s],(a=>{i=i.add(a.key)})),i}containsKey(t){const e=new wt(t,0),n=this.kr.firstAfterOrEqual(e);return n!==null&&t.isEqual(n.key)}}class wt{constructor(t,e){this.key=t,this.Jr=e}static qr(t,e){return k.comparator(t.key,e.key)||z(t.Jr,e.Jr)}static Ur(t,e){return z(t.Jr,e.Jr)||k.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tp{constructor(t){this.ti=t,this.docs=(function(){return new it(k.comparator)})(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,s=this.docs.get(n),i=s?s.size:0,a=this.ti(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:a}),this.size+=a-i,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return A.resolve(n?n.document.mutableCopy():at.newInvalidDocument(e))}getEntries(t,e){let n=Lt();return e.forEach((s=>{const i=this.docs.get(s);n=n.insert(s,i?i.document.mutableCopy():at.newInvalidDocument(s))})),A.resolve(n)}getDocumentsMatchingQuery(t,e,n,s){let i=Lt();const a=e.path,u=new k(a.child("__id-9223372036854775808__")),c=this.docs.getIteratorFrom(u);for(;c.hasNext();){const{key:h,value:{document:f}}=c.getNext();if(!a.isPrefixOf(h.path))break;h.path.length>a.length+1||ra(Xl(f),n)<=0||(s.has(f.key)||ms(e,f))&&(i=i.insert(f.key,f.mutableCopy()))}return A.resolve(i)}getAllFromCollectionGroup(t,e,n,s){O(9500)}ni(t,e){return A.forEach(this.docs,(n=>e(n)))}newChangeBuffer(t){return new Ep(this)}getSize(t){return A.resolve(this.size)}}class Ep extends Ad{constructor(t){super(),this.Mr=t}applyChanges(t){const e=[];return this.changes.forEach(((n,s)=>{s.isValidDocument()?e.push(this.Mr.addEntry(t,s)):this.Mr.removeEntry(n)})),A.waitFor(e)}getFromCache(t,e){return this.Mr.getEntry(t,e)}getAllFromCache(t,e){return this.Mr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vp{constructor(t){this.serializer=t}k(t,e,n,s){const i=new Ei("createOrUpgrade",e);n<1&&s>=1&&((function(c){c.createObjectStore(hs)})(t),(function(c){c.createObjectStore(Yr,{keyPath:Om}),c.createObjectStore(Qt,{keyPath:_c,autoIncrement:!0}).createIndex(nn,yc,{unique:!0}),c.createObjectStore(jn)})(t),al(t),(function(c){c.createObjectStore(Ye)})(t));let a=A.resolve();return n<3&&s>=3&&(n!==0&&((function(c){c.deleteObjectStore(Gn),c.deleteObjectStore(zn),c.deleteObjectStore(sn)})(t),al(t)),a=a.next((()=>(function(c){const h=c.store(sn),f={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:B.min().toTimestamp(),targetCount:0};return h.put(ai,f)})(i)))),n<4&&s>=4&&(n!==0&&(a=a.next((()=>(function(c,h){return h.store(Qt).J().next((m=>{c.deleteObjectStore(Qt),c.createObjectStore(Qt,{keyPath:_c,autoIncrement:!0}).createIndex(nn,yc,{unique:!0});const p=h.store(Qt),v=m.map((C=>p.put(C)));return A.waitFor(v)}))})(t,i)))),a=a.next((()=>{(function(c){c.createObjectStore(Kn,{keyPath:$m})})(t)}))),n<5&&s>=5&&(a=a.next((()=>this.gi(i)))),n<6&&s>=6&&(a=a.next((()=>((function(c){c.createObjectStore(Xr)})(t),this.pi(i))))),n<7&&s>=7&&(a=a.next((()=>this.yi(i)))),n<8&&s>=8&&(a=a.next((()=>this.wi(t,i)))),n<9&&s>=9&&(a=a.next((()=>{(function(c){c.objectStoreNames.contains("remoteDocumentChanges")&&c.deleteObjectStore("remoteDocumentChanges")})(t)}))),n<10&&s>=10&&(a=a.next((()=>this.Si(i)))),n<11&&s>=11&&(a=a.next((()=>{(function(c){c.createObjectStore(wi,{keyPath:Qm})})(t),(function(c){c.createObjectStore(Ai,{keyPath:Wm})})(t)}))),n<12&&s>=12&&(a=a.next((()=>{(function(c){const h=c.createObjectStore(vi,{keyPath:eg});h.createIndex(No,ng,{unique:!1}),h.createIndex(uh,rg,{unique:!1})})(t)}))),n<13&&s>=13&&(a=a.next((()=>(function(c){const h=c.createObjectStore(oi,{keyPath:qm});h.createIndex(Hs,Bm),h.createIndex(sh,Um)})(t))).next((()=>this.bi(t,i))).next((()=>t.deleteObjectStore(Ye)))),n<14&&s>=14&&(a=a.next((()=>this.Di(t,i)))),n<15&&s>=15&&(a=a.next((()=>(function(c){c.createObjectStore(oa,{keyPath:Hm,autoIncrement:!0}).createIndex(Do,Jm,{unique:!1}),c.createObjectStore(zr,{keyPath:Ym}).createIndex(oh,Xm,{unique:!1}),c.createObjectStore(Gr,{keyPath:Zm}).createIndex(ah,tg,{unique:!1})})(t)))),n<16&&s>=16&&(a=a.next((()=>{e.objectStore(zr).clear()})).next((()=>{e.objectStore(Gr).clear()}))),n<17&&s>=17&&(a=a.next((()=>{(function(c){c.createObjectStore(aa,{keyPath:sg})})(t)}))),n<18&&s>=18&&ql()&&(a=a.next((()=>{e.objectStore(zr).clear()})).next((()=>{e.objectStore(Gr).clear()}))),a}pi(t){let e=0;return t.store(Ye).ee(((n,s)=>{e+=fi(s)})).next((()=>{const n={byteSize:e};return t.store(Xr).put(xo,n)}))}gi(t){const e=t.store(Yr),n=t.store(Qt);return e.J().next((s=>A.forEach(s,(i=>{const a=IDBKeyRange.bound([i.userId,be],[i.userId,i.lastAcknowledgedBatchId]);return n.J(nn,a).next((u=>A.forEach(u,(c=>{L(c.userId===i.userId,18650,"Cannot process batch from unexpected user",{batchId:c.batchId});const h=Ze(this.serializer,c);return _d(t,i.userId,h).next((()=>{}))}))))}))))}yi(t){const e=t.store(Gn),n=t.store(Ye);return t.store(sn).get(ai).next((s=>{const i=[];return n.ee(((a,u)=>{const c=new $(a),h=(function(m){return[0,xt(m)]})(c);i.push(e.get(h).next((f=>f?A.resolve():(m=>e.put({targetId:0,path:xt(m),sequenceNumber:s.highestListenSequenceNumber}))(c))))})).next((()=>A.waitFor(i)))}))}wi(t,e){t.createObjectStore(Zr,{keyPath:Km});const n=e.store(Zr),s=new wa,i=a=>{if(s.add(a)){const u=a.lastSegment(),c=a.popLast();return n.put({collectionId:u,parent:xt(c)})}};return e.store(Ye).ee({Y:!0},((a,u)=>{const c=new $(a);return i(c.popLast())})).next((()=>e.store(jn).ee({Y:!0},(([a,u,c],h)=>{const f=Xt(u);return i(f.popLast())}))))}Si(t){const e=t.store(zn);return e.ee(((n,s)=>{const i=Br(s),a=fd(this.serializer,i);return e.put(a)}))}bi(t,e){const n=e.store(Ye),s=[];return n.ee(((i,a)=>{const u=e.store(oi),c=(function(m){return m.document?new k($.fromString(m.document.name).popFirst(5)):m.noDocument?k.fromSegments(m.noDocument.path):m.unknownDocument?k.fromSegments(m.unknownDocument.path):O(36783)})(a).path.toArray(),h={prefixPath:c.slice(0,c.length-2),collectionGroup:c[c.length-2],documentId:c[c.length-1],readTime:a.readTime||[0,0],unknownDocument:a.unknownDocument,noDocument:a.noDocument,document:a.document,hasCommittedMutations:!!a.hasCommittedMutations};s.push(u.put(h))})).next((()=>A.waitFor(s)))}Di(t,e){const n=e.store(Qt),s=vd(this.serializer),i=new va(Mi.Vi,this.serializer.yt);return n.J().next((a=>{const u=new Map;return a.forEach((c=>{let h=u.get(c.userId)??G();Ze(this.serializer,c).keys().forEach((f=>h=h.add(f))),u.set(c.userId,h)})),A.forEach(u,((c,h)=>{const f=new At(h),m=Ni.wt(this.serializer,f),p=i.getIndexManager(f),v=ki.wt(f,this.serializer,p,i.referenceDelegate);return new Rd(s,v,m,p).recalculateAndSaveOverlaysForDocumentKeys(new ko(e,Ft.ce),c).next()}))}))}}function al(r){r.createObjectStore(Gn,{keyPath:zm}).createIndex(ia,Gm,{unique:!0}),r.createObjectStore(zn,{keyPath:"targetId"}).createIndex(ih,jm,{unique:!0}),r.createObjectStore(sn)}const we="IndexedDbPersistence",Io=18e5,To=5e3,Eo="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.",Pd="main";class Ra{constructor(t,e,n,s,i,a,u,c,h,f,m=18){if(this.allowTabSynchronization=t,this.persistenceKey=e,this.clientId=n,this.Ci=i,this.window=a,this.document=u,this.Fi=h,this.Mi=f,this.xi=m,this.ai=null,this.ui=!1,this.isPrimary=!1,this.networkEnabled=!0,this.Oi=null,this.inForeground=!1,this.Ni=null,this.Bi=null,this.Li=Number.NEGATIVE_INFINITY,this.ki=p=>Promise.resolve(),!Ra.v())throw new b(P.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new dp(this,s),this.qi=e+Pd,this.serializer=new dd(c),this.Ki=new te(this.qi,this.xi,new vp(this.serializer)),this.ci=new ep,this.li=new cp(this.referenceDelegate,this.serializer),this.remoteDocumentCache=vd(this.serializer),this.Pi=new tp,this.window&&this.window.localStorage?this.Ui=this.window.localStorage:(this.Ui=null,f===!1&&mt(we,"LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.$i().then((()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new b(P.FAILED_PRECONDITION,Eo);return this.Wi(),this.Qi(),this.Gi(),this.runTransaction("getHighestListenSequenceNumber","readonly",(t=>this.li.getHighestSequenceNumber(t)))})).then((t=>{this.ai=new Ft(t,this.Fi)})).then((()=>{this.ui=!0})).catch((t=>(this.Ki&&this.Ki.close(),Promise.reject(t))))}zi(t){return this.ki=async e=>{if(this.started)return t(e)},t(this.isPrimary)}setDatabaseDeletedListener(t){this.Ki.K((async e=>{e.newVersion===null&&await t()}))}setNetworkEnabled(t){this.networkEnabled!==t&&(this.networkEnabled=t,this.Ci.enqueueAndForget((async()=>{this.started&&await this.$i()})))}$i(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",(t=>Gs(t).put({clientId:this.clientId,updateTimeMs:Date.now(),networkEnabled:this.networkEnabled,inForeground:this.inForeground}).next((()=>{if(this.isPrimary)return this.ji(t).next((e=>{e||(this.isPrimary=!1,this.Ci.enqueueRetryable((()=>this.ki(!1))))}))})).next((()=>this.Ji(t))).next((e=>this.isPrimary&&!e?this.Hi(t).next((()=>!1)):!!e&&this.Zi(t).next((()=>!0)))))).catch((t=>{if(Le(t))return x(we,"Failed to extend owner lease: ",t),this.isPrimary;if(!this.allowTabSynchronization)throw t;return x(we,"Releasing owner lease after error during lease refresh",t),!1})).then((t=>{this.isPrimary!==t&&this.Ci.enqueueRetryable((()=>this.ki(t))),this.isPrimary=t}))}ji(t){return Mr(t).get(Rn).next((e=>A.resolve(this.Xi(e))))}Yi(t){return Gs(t).delete(this.clientId)}async es(){if(this.isPrimary&&!this.ts(this.Li,Io)){this.Li=Date.now();const t=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",(e=>{const n=Tt(e,Kn);return n.J().next((s=>{const i=this.ns(s,Io),a=s.filter((u=>i.indexOf(u)===-1));return A.forEach(a,(u=>n.delete(u.clientId))).next((()=>a))}))})).catch((()=>[]));if(this.Ui)for(const e of t)this.Ui.removeItem(this.rs(e.clientId))}}Gi(){this.Bi=this.Ci.enqueueAfterDelay("client_metadata_refresh",4e3,(()=>this.$i().then((()=>this.es())).then((()=>this.Gi()))))}Xi(t){return!!t&&t.ownerId===this.clientId}Ji(t){return this.Mi?A.resolve(!0):Mr(t).get(Rn).next((e=>{if(e!==null&&this.ts(e.leaseTimestampMs,To)&&!this.ss(e.ownerId)){if(this.Xi(e)&&this.networkEnabled)return!0;if(!this.Xi(e)){if(!e.allowTabSynchronization)throw new b(P.FAILED_PRECONDITION,Eo);return!1}}return!(!this.networkEnabled||!this.inForeground)||Gs(t).J().next((n=>this.ns(n,To).find((s=>{if(this.clientId!==s.clientId){const i=!this.networkEnabled&&s.networkEnabled,a=!this.inForeground&&s.inForeground,u=this.networkEnabled===s.networkEnabled;if(i||a&&u)return!0}return!1}))===void 0))})).next((e=>(this.isPrimary!==e&&x(we,`Client ${e?"is":"is not"} eligible for a primary lease.`),e)))}async shutdown(){this.ui=!1,this._s(),this.Bi&&(this.Bi.cancel(),this.Bi=null),this.us(),this.cs(),await this.Ki.runTransaction("shutdown","readwrite",[hs,Kn],(t=>{const e=new ko(t,Ft.ce);return this.Hi(e).next((()=>this.Yi(e)))})),this.Ki.close(),this.ls()}ns(t,e){return t.filter((n=>this.ts(n.updateTimeMs,e)&&!this.ss(n.clientId)))}hs(){return this.runTransaction("getActiveClients","readonly",(t=>Gs(t).J().next((e=>this.ns(e,Io).map((n=>n.clientId))))))}get started(){return this.ui}getGlobalsCache(){return this.ci}getMutationQueue(t,e){return ki.wt(t,this.serializer,e,this.referenceDelegate)}getTargetCache(){return this.li}getRemoteDocumentCache(){return this.remoteDocumentCache}getIndexManager(t){return new up(t,this.serializer.yt.databaseId)}getDocumentOverlayCache(t){return Ni.wt(this.serializer,t)}getBundleCache(){return this.Pi}runTransaction(t,e,n){x(we,"Starting transaction:",t);const s=e==="readonly"?"readonly":"readwrite",i=(function(c){return c===18?ag:c===17?dh:c===16?og:c===15?ua:c===14?hh:c===13?lh:c===12?ig:c===11?ch:void O(60245)})(this.xi);let a;return this.Ki.runTransaction(t,s,i,(u=>(a=new ko(u,this.ai?this.ai.next():Ft.ce),e==="readwrite-primary"?this.ji(a).next((c=>!!c||this.Ji(a))).next((c=>{if(!c)throw mt(`Failed to obtain primary lease for action '${t}'.`),this.isPrimary=!1,this.Ci.enqueueRetryable((()=>this.ki(!1))),new b(P.FAILED_PRECONDITION,Zl);return n(a)})).next((c=>this.Zi(a).next((()=>c)))):this.Ps(a).next((()=>n(a)))))).then((u=>(a.raiseOnCommittedEvent(),u)))}Ps(t){return Mr(t).get(Rn).next((e=>{if(e!==null&&this.ts(e.leaseTimestampMs,To)&&!this.ss(e.ownerId)&&!this.Xi(e)&&!(this.Mi||this.allowTabSynchronization&&e.allowTabSynchronization))throw new b(P.FAILED_PRECONDITION,Eo)}))}Zi(t){const e={ownerId:this.clientId,allowTabSynchronization:this.allowTabSynchronization,leaseTimestampMs:Date.now()};return Mr(t).put(Rn,e)}static v(){return te.v()}Hi(t){const e=Mr(t);return e.get(Rn).next((n=>this.Xi(n)?(x(we,"Releasing primary lease."),e.delete(Rn)):A.resolve()))}ts(t,e){const n=Date.now();return!(t<n-e)&&(!(t>n)||(mt(`Detected an update time that is in the future: ${t} > ${n}`),!1))}Wi(){this.document!==null&&typeof this.document.addEventListener=="function"&&(this.Ni=()=>{this.Ci.enqueueAndForget((()=>(this.inForeground=this.document.visibilityState==="visible",this.$i())))},this.document.addEventListener("visibilitychange",this.Ni),this.inForeground=this.document.visibilityState==="visible")}us(){this.Ni&&(this.document.removeEventListener("visibilitychange",this.Ni),this.Ni=null)}Qi(){var t;typeof((t=this.window)==null?void 0:t.addEventListener)=="function"&&(this.Oi=()=>{this._s();const e=/(?:Version|Mobile)\/1[456]/;Ll()&&(navigator.appVersion.match(e)||navigator.userAgent.match(e))&&this.Ci.enterRestrictedMode(!0),this.Ci.enqueueAndForget((()=>this.shutdown()))},this.window.addEventListener("pagehide",this.Oi))}cs(){this.Oi&&(this.window.removeEventListener("pagehide",this.Oi),this.Oi=null)}ss(t){var e;try{const n=((e=this.Ui)==null?void 0:e.getItem(this.rs(t)))!==null;return x(we,`Client '${t}' ${n?"is":"is not"} zombied in LocalStorage`),n}catch(n){return mt(we,"Failed to get zombied client id.",n),!1}}_s(){if(this.Ui)try{this.Ui.setItem(this.rs(this.clientId),String(Date.now()))}catch(t){mt("Failed to set zombie client id.",t)}}ls(){if(this.Ui)try{this.Ui.removeItem(this.rs(this.clientId))}catch{}}rs(t){return`firestore_zombie_${this.persistenceKey}_${t}`}}function Mr(r){return Tt(r,hs)}function Gs(r){return Tt(r,Kn)}function Pa(r,t){let e=r.projectId;return r.isDefaultDatabase||(e+="."+r.database),"firestore/"+t+"/"+e+"/"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(t,e,n,s){this.targetId=t,this.fromCache=e,this.Ts=n,this.Es=s}static Is(t,e){let n=G(),s=G();for(const i of e.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Sa(t,e.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return Ll()?8:eh(si())>0?6:4})()}initialize(t,e){this.fs=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,n,s){const i={result:null};return this.gs(t,e).next((a=>{i.result=a})).next((()=>{if(!i.result)return this.ps(t,e,s,n).next((a=>{i.result=a}))})).next((()=>{if(i.result)return;const a=new Rp;return this.ys(t,e,a).next((u=>{if(i.result=u,this.As)return this.ws(t,e,a,u.size)}))})).next((()=>i.result))}ws(t,e,n,s){return n.documentReadCount<this.Vs?(xn()<=ie.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",Dn(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),A.resolve()):(xn()<=ie.DEBUG&&x("QueryEngine","Query:",Dn(e),"scans",n.documentReadCount,"local documents and returns",s,"documents as results."),n.documentReadCount>this.ds*s?(xn()<=ie.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",Dn(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Dt(e))):A.resolve())}gs(t,e){if(xc(e))return A.resolve(null);let n=Dt(e);return this.indexManager.getIndexType(t,n).next((s=>s===0?null:(e.limit!==null&&s===1&&(e=li(e,null,"F"),n=Dt(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next((i=>{const a=G(...i);return this.fs.getDocuments(t,a).next((u=>this.indexManager.getMinOffset(t,n).next((c=>{const h=this.Ss(e,u);return this.bs(e,h,a,c.readTime)?this.gs(t,li(e,null,"F")):this.Ds(t,h,e,c)}))))})))))}ps(t,e,n,s){return xc(e)||s.isEqual(B.min())?A.resolve(null):this.fs.getDocuments(t,n).next((i=>{const a=this.Ss(e,i);return this.bs(e,a,n,s)?A.resolve(null):(xn()<=ie.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Dn(e)),this.Ds(t,a,e,Yl(s,qn)).next((u=>u)))}))}Ss(t,e){let n=new et(Fh(t));return e.forEach(((s,i)=>{ms(t,i)&&(n=n.add(i))})),n}bs(t,e,n,s){if(t.limit===null)return!1;if(n.size!==e.size)return!0;const i=t.limitType==="F"?e.last():e.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ys(t,e,n){return xn()<=ie.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",Dn(e)),this.fs.getDocumentsMatchingQuery(t,e,Kt.min(),n)}Ds(t,e,n,s){return this.fs.getDocumentsMatchingQuery(t,n,s).next((i=>(e.forEach((a=>{i=i.insert(a.key,a)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Md="firestore_clients";function ul(r,t){return`${Md}_${r}_${t}`}const Fd="firestore_mutations";function cl(r,t,e){let n=`${Fd}_${r}_${e}`;return t.isAuthenticated()&&(n+=`_${t.uid}`),n}const Od="firestore_targets";function wo(r,t){return`${Od}_${r}_${t}`}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fp{constructor(t){this.Jo=t.Jo,this.Ho=t.Ho}Zo(t){this.Xo=t}Yo(t){this.e_=t}t_(t){this.n_=t}onMessage(t){this.r_=t}close(){this.Ho()}send(t){this.Jo(t)}i_(){this.Xo()}s_(){this.e_()}o_(t){this.n_(t)}__(t){this.r_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="WebChannelConnection",Fr=(r,t,e)=>{r.listen(t,(n=>{try{e(n)}catch(s){setTimeout((()=>{throw s}),0)}}))};class Fn extends Mp{constructor(t){super(t),this.a_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}static u_(){if(!Fn.c_){const t=Gl();Fr(t,zl.STAT_EVENT,(e=>{e.stat===Po.PROXY?x(bt,"STAT_EVENT: detected buffering proxy"):e.stat===Po.NOPROXY&&x(bt,"STAT_EVENT: detected no buffering proxy")})),Fn.c_=!0}}zo(t,e,n,s,i){const a=Ho();return new Promise(((u,c)=>{const h=new Ul;h.setWithCredentials(!0),h.listenOnce(jl.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case Qs.NO_ERROR:const m=h.getResponseJson();x(bt,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(m)),u(m);break;case Qs.TIMEOUT:x(bt,`RPC '${t}' ${a} timed out`),c(new b(P.DEADLINE_EXCEEDED,"Request time out"));break;case Qs.HTTP_ERROR:const p=h.getStatus();if(x(bt,`RPC '${t}' ${a} failed with status:`,p,"response text:",h.getResponseText()),p>0){let v=h.getResponseJson();Array.isArray(v)&&(v=v[0]);const C=v==null?void 0:v.error;if(C&&C.status&&C.message){const N=(function(q){const j=q.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(j)>=0?j:P.UNKNOWN})(C.status);c(new b(N,C.message))}else c(new b(P.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new b(P.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:a,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{x(bt,`RPC '${t}' ${a} completed.`)}}));const f=JSON.stringify(s);x(bt,`RPC '${t}' ${a} sending request:`,s),h.send(e,"POST",f,n,15)}))}T_(t,e,n){const s=Ho(),i=[this.Ko,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(u.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,e,n),u.encodeInitMessageHeaders=!0;const h=i.join("");x(bt,`Creating RPC '${t}' stream ${s}: ${h}`,u);const f=a.createWebChannel(h,u);this.E_(f);let m=!1,p=!1;const v=new Fp({Jo:C=>{p?x(bt,`Not sending because RPC '${t}' stream ${s} is closed:`,C):(m||(x(bt,`Opening RPC '${t}' stream ${s} transport.`),f.open(),m=!0),x(bt,`RPC '${t}' stream ${s} sending:`,C),f.send(C))},Ho:()=>f.close()});return Fr(f,Or.EventType.OPEN,(()=>{p||(x(bt,`RPC '${t}' stream ${s} transport opened.`),v.i_())})),Fr(f,Or.EventType.CLOSE,(()=>{p||(p=!0,x(bt,`RPC '${t}' stream ${s} transport closed`),v.o_(),this.I_(f))})),Fr(f,Or.EventType.ERROR,(C=>{p||(p=!0,Gt(bt,`RPC '${t}' stream ${s} transport errored. Name:`,C.name,"Message:",C.message),v.o_(new b(P.UNAVAILABLE,"The operation could not be completed")))})),Fr(f,Or.EventType.MESSAGE,(C=>{var N;if(!p){const D=C.data[0];L(!!D,16349);const q=D,j=(q==null?void 0:q.error)||((N=q[0])==null?void 0:N.error);if(j){x(bt,`RPC '${t}' stream ${s} received error:`,j);const U=j.status;let X=(function(T){const _=pt[T];if(_!==void 0)return Jh(_)})(U),J=j.message;U==="NOT_FOUND"&&J.includes("database")&&J.includes("does not exist")&&J.includes(this.databaseId.database)&&Gt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),X===void 0&&(X=P.INTERNAL,J="Unknown error status: "+U+" with message "+j.message),p=!0,v.o_(new b(X,J)),f.close()}else x(bt,`RPC '${t}' stream ${s} received:`,D),v.__(D)}})),Fn.u_(),setTimeout((()=>{v.s_()}),0),v}terminate(){this.a_.forEach((t=>t.close())),this.a_=[]}E_(t){this.a_.push(t)}I_(t){this.a_=this.a_.filter((e=>e===t))}Go(t,e,n){super.Go(t,e,n),this.databaseInfo.apiKey&&(t["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Kl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dl="PersistentStream";class Bd{constructor(t,e,n,s,i,a,u,c){this.Ci=t,this.S_=n,this.b_=s,this.connection=i,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=u,this.listener=c,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new Ca(t,e)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Ci.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(t){this.K_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}K_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,e){this.K_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():e&&e.code===P.RESOURCE_EXHAUSTED?(mt(e.toString()),mt("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):e&&e.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.W_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.t_(e)}W_(){}auth(){this.state=1;const t=this.Q_(this.D_),e=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([n,s])=>{this.D_===e&&this.G_(n,s)}),(n=>{t((()=>{const s=new b(P.UNKNOWN,"Fetching auth token failed: "+n.message);return this.z_(s)}))}))}G_(t,e){const n=this.Q_(this.D_);this.stream=this.j_(t,e),this.stream.Zo((()=>{n((()=>this.listener.Zo()))})),this.stream.Yo((()=>{n((()=>(this.state=2,this.v_=this.Ci.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.Yo())))})),this.stream.t_((s=>{n((()=>this.z_(s)))})),this.stream.onMessage((s=>{n((()=>++this.F_==1?this.J_(s):this.onNext(s)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(t){return x(dl,`close with error: ${t}`),this.stream=null,this.close(4,t)}Q_(t){return e=>{this.Ci.enqueueAndForget((()=>this.D_===t?e():(x(dl,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Lp extends Bd{constructor(t,e,n,s,i,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,s,a),this.serializer=i}j_(t,e){return this.connection.T_("Listen",t,e)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const e=$g(this.serializer,t),n=(function(i){if(!("targetChange"in i))return B.min();const a=i.targetChange;return a.targetIds&&a.targetIds.length?B.min():a.readTime?gt(a.readTime):B.min()})(t);return this.listener.H_(e,n)}Z_(t){const e={};e.database=zo(this.serializer),e.addTarget=(function(i,a){let u;const c=a.target;if(u=ui(c)?{documents:id(i,c)}:{query:xi(i,c).ft},u.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){u.resumeToken=td(i,a.resumeToken);const h=Uo(i,a.expectedCount);h!==null&&(u.expectedCount=h)}else if(a.snapshotVersion.compareTo(B.min())>0){u.readTime=Yn(i,a.snapshotVersion.toTimestamp());const h=Uo(i,a.expectedCount);h!==null&&(u.expectedCount=h)}return u})(this.serializer,t);const n=Wg(this.serializer,t);n&&(e.labels=n),this.q_(e)}X_(t){const e={};e.database=zo(this.serializer),e.removeTarget=t,this.q_(e)}}class qp extends Bd{constructor(t,e,n,s,i,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,s,a),this.serializer=i}get Y_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}W_(){this.Y_&&this.ea([])}j_(t,e){return this.connection.T_("Write",t,e)}J_(t){return L(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,L(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){L(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const e=Qg(t.writeResults,t.commitTime),n=gt(t.commitTime);return this.listener.na(n,e)}ra(){const t={};t.database=zo(this.serializer),this.q_(t)}ea(t){const e={streamToken:this.lastStreamToken,writes:t.map((n=>os(this.serializer,n)))};this.q_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gn="RemoteStore";class Gp{constructor(t,e,n,s,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo((a=>{n.enqueueAndForget((async()=>{Be(this)&&(x(gn,"Restarting streams for network reachability change."),await(async function(c){const h=M(c);h.Ia.add(4),await ur(h),h.Va.set("Unknown"),h.Ia.delete(4),await ys(h)})(this))}))})),this.Va=new zp(n,s)}}async function ys(r){if(Be(r))for(const t of r.Ra)await t(!0)}async function ur(r){for(const t of r.Ra)await t(!1)}function Fi(r,t){const e=M(r);e.Ea.has(t.targetId)||(e.Ea.set(t.targetId,t),Na(e)?Da(e):lr(e).O_()&&xa(e,t))}function tr(r,t){const e=M(r),n=lr(e);e.Ea.delete(t),n.O_()&&Ud(e,t),e.Ea.size===0&&(n.O_()?n.L_():Be(e)&&e.Va.set("Unknown"))}function xa(r,t){if(r.da.$e(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(B.min())>0){const e=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}lr(r).Z_(t)}function Ud(r,t){r.da.$e(t),lr(r).X_(t)}function Da(r){r.da=new qg({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ea.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),lr(r).start(),r.Va.ua()}function Na(r){return Be(r)&&!lr(r).x_()&&r.Ea.size>0}function Be(r){return M(r).Ia.size===0}function jd(r){r.da=void 0}async function Kp(r){r.Va.set("Online")}async function $p(r){r.Ea.forEach(((t,e)=>{xa(r,t)}))}async function Qp(r,t){jd(r),Na(r)?(r.Va.ha(t),Da(r)):r.Va.set("Unknown")}async function Wp(r,t,e){if(r.Va.set("Online"),t instanceof Zh&&t.state===2&&t.cause)try{await(async function(s,i){const a=i.cause;for(const u of i.targetIds)s.Ea.has(u)&&(await s.remoteSyncer.rejectListen(u,a),s.Ea.delete(u),s.da.removeTarget(u))})(r,t)}catch(n){x(gn,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await yi(r,n)}else if(t instanceof ti?r.da.Xe(t):t instanceof Xh?r.da.st(t):r.da.tt(t),!e.isEqual(B.min()))try{const n=await Cd(r.localStore);e.compareTo(n)>=0&&await(function(i,a){const u=i.da.Tt(a);return u.targetChanges.forEach(((c,h)=>{if(c.resumeToken.approximateByteSize()>0){const f=i.Ea.get(h);f&&i.Ea.set(h,f.withResumeToken(c.resumeToken,a))}})),u.targetMismatches.forEach(((c,h)=>{const f=i.Ea.get(c);if(!f)return;i.Ea.set(c,f.withResumeToken(ft.EMPTY_BYTE_STRING,f.snapshotVersion)),Ud(i,c);const m=new oe(f.target,c,h,f.sequenceNumber);xa(i,m)})),i.remoteSyncer.applyRemoteEvent(u)})(r,e)}catch(n){x(gn,"Failed to raise snapshot:",n),await yi(r,n)}}async function yi(r,t,e){if(!Le(t))throw t;r.Ia.add(1),await ur(r),r.Va.set("Offline"),e||(e=()=>Cd(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{x(gn,"Retrying IndexedDB access"),await e(),r.Ia.delete(1),await ys(r)}))}function zd(r,t){return t().catch((e=>yi(r,e,t)))}async function cr(r){const t=M(r),e=ke(t);let n=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:be;for(;Hp(t);)try{const s=await Cp(t.localStore,n);if(s===null){t.Ta.length===0&&e.L_();break}n=s.batchId,Jp(t,s)}catch(s){await yi(t,s)}Gd(t)&&Kd(t)}function Hp(r){return Be(r)&&r.Ta.length<10}function Jp(r,t){r.Ta.push(t);const e=ke(r);e.O_()&&e.Y_&&e.ea(t.mutations)}function Gd(r){return Be(r)&&!ke(r).x_()&&r.Ta.length>0}function Kd(r){ke(r).start()}async function Yp(r){ke(r).ra()}async function Xp(r){const t=ke(r);for(const e of r.Ta)t.ea(e.mutations)}async function Zp(r,t,e){const n=r.Ta.shift(),s=_a.from(n,t,e);await zd(r,(()=>r.remoteSyncer.applySuccessfulWrite(s))),await cr(r)}async function t_(r,t){t&&ke(r).Y_&&await(async function(n,s){if((function(a){return Hh(a)&&a!==P.ABORTED})(s.code)){const i=n.Ta.shift();ke(n).B_(),await zd(n,(()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s))),await cr(n)}})(r,t),Gd(r)&&Kd(r)}async function fl(r,t){const e=M(r);e.asyncQueue.verifyOperationInProgress(),x(gn,"RemoteStore received new credentials");const n=Be(e);e.Ia.add(3),await ur(e),n&&e.Va.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ia.delete(3),await ys(e)}async function Jo(r,t){const e=M(r);t?(e.Ia.delete(2),await ys(e)):t||(e.Ia.add(2),await ur(e),e.Va.set("Unknown"))}function lr(r){return r.ma||(r.ma=(function(e,n,s){const i=M(e);return i.sa(),new Lp(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:Kp.bind(null,r),Yo:$p.bind(null,r),t_:Qp.bind(null,r),H_:Wp.bind(null,r)}),r.Ra.push((async t=>{t?(r.ma.B_(),Na(r)?Da(r):r.Va.set("Unknown")):(await r.ma.stop(),jd(r))}))),r.ma}function ke(r){return r.fa||(r.fa=(function(e,n,s){const i=M(e);return i.sa(),new qp(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Yp.bind(null,r),t_:t_.bind(null,r),ta:Xp.bind(null,r),na:Zp.bind(null,r)}),r.Ra.push((async t=>{t?(r.fa.B_(),await cr(r)):(await r.fa.stop(),r.Ta.length>0&&(x(gn,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))}))),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(t,e){this.Ka=t,this.byteLength=e}Ua(){return"metadata"in this.Ka}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _l{constructor(t){this.serializer=t}qs(t){return ee(this.serializer,t)}Ks(t){return t.metadata.exists?Ci(this.serializer,t.document,!1):at.newNoDocument(this.qs(t.metadata.name),this.Us(t.metadata.readTime))}Us(t){return gt(t)}}class qa{constructor(t,e){this.$a=t,this.serializer=e,this.Wa=[],this.Qa=[],this.collectionGroups=new Set,this.progress=Qd(t)}get queries(){return this.Wa}get documents(){return this.Qa}Ga(t){this.progress.bytesLoaded+=t.byteLength;let e=this.progress.documentsLoaded;if(t.Ka.namedQuery)this.Wa.push(t.Ka.namedQuery);else if(t.Ka.documentMetadata){this.Qa.push({metadata:t.Ka.documentMetadata}),t.Ka.documentMetadata.exists||++e;const n=$.fromString(t.Ka.documentMetadata.name);this.collectionGroups.add(n.get(n.length-2))}else t.Ka.document&&(this.Qa[this.Qa.length-1].document=t.Ka.document,++e);return e!==this.progress.documentsLoaded?(this.progress.documentsLoaded=e,{...this.progress}):null}za(t){const e=new Map,n=new _l(this.serializer);for(const s of t)if(s.metadata.queries){const i=n.qs(s.metadata.name);for(const a of s.metadata.queries){const u=(e.get(a)||G()).add(i);e.set(a,u)}}return e}async ja(t){const e=await xp(t,new _l(this.serializer),this.Qa,this.$a.id),n=this.za(this.documents);for(const s of this.Wa)await Dp(t,s,n.get(s.name));return this.progress.taskState="Success",{progress:this.progress,Ja:this.collectionGroups,Ha:e}}}function Qd(r){return{taskState:"Running",documentsLoaded:0,bytesLoaded:0,totalDocuments:r.totalDocuments,totalBytes:r.totalBytes}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(t){this.key=t}}class Hd{constructor(t){this.key=t}}class Jd{constructor(t,e){this.query=t,this.Za=e,this.Xa=null,this.hasCachedResults=!1,this.current=!1,this.Ya=G(),this.mutatedKeys=G(),this.eu=Fh(t),this.tu=new on(this.eu)}get nu(){return this.Za}ru(t,e){const n=e?e.iu:new ml,s=e?e.tu:this.tu;let i=e?e.mutatedKeys:this.mutatedKeys,a=s,u=!1;const c=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,h=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(t.inorderTraversal(((f,m)=>{const p=s.get(f),v=ms(this.query,m)?m:null,C=!!p&&this.mutatedKeys.has(p.key),N=!!v&&(v.hasLocalMutations||this.mutatedKeys.has(v.key)&&v.hasCommittedMutations);let D=!1;p&&v?p.data.isEqual(v.data)?C!==N&&(n.track({type:3,doc:v}),D=!0):this.su(p,v)||(n.track({type:2,doc:v}),D=!0,(c&&this.eu(v,c)>0||h&&this.eu(v,h)<0)&&(u=!0)):!p&&v?(n.track({type:0,doc:v}),D=!0):p&&!v&&(n.track({type:1,doc:p}),D=!0,(c||h)&&(u=!0)),D&&(v?(a=a.add(v),i=N?i.add(f):i.delete(f)):(a=a.delete(f),i=i.delete(f)))})),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),i=i.delete(f.key),n.track({type:1,doc:f})}return{tu:a,iu:n,bs:u,mutatedKeys:i}}su(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,s){const i=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const a=t.iu.ya();a.sort(((f,m)=>(function(v,C){const N=D=>{switch(D){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return O(20277,{Vt:D})}};return N(v)-N(C)})(f.type,m.type)||this.eu(f.doc,m.doc))),this.ou(n),s=s??!1;const u=e&&!s?this._u():[],c=this.Ya.size===0&&this.current&&!s?1:0,h=c!==this.Xa;return this.Xa=c,a.length!==0||h?{snapshot:new pn(this.query,t.tu,i,a,t.mutatedKeys,c===0,h,!1,!!n&&n.resumeToken.approximateByteSize()>0),au:u}:{au:u}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new ml,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{au:[]}}uu(t){return!this.Za.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((e=>this.Za=this.Za.add(e))),t.modifiedDocuments.forEach((e=>{})),t.removedDocuments.forEach((e=>this.Za=this.Za.delete(e))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Ya;this.Ya=G(),this.tu.forEach((n=>{this.uu(n.key)&&(this.Ya=this.Ya.add(n.key))}));const e=[];return t.forEach((n=>{this.Ya.has(n)||e.push(new Hd(n))})),this.Ya.forEach((n=>{t.has(n)||e.push(new Wd(n))})),e}cu(t){this.Za=t.ks,this.Ya=G();const e=this.ru(t.documents);return this.applyChanges(e,!0)}lu(){return pn.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Xa===0,this.hasCachedResults)}}const Ue="SyncEngine";class i_{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class o_{constructor(t){this.key=t,this.hu=!1}}class a_{constructor(t,e,n,s,i,a){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new he((u=>kh(u)),fs),this.Eu=new Map,this.Iu=new Set,this.Ru=new it(k.comparator),this.Au=new Map,this.Vu=new Aa,this.du={},this.mu=new Map,this.fu=mn.ar(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function u_(r,t,e=!0){const n=Oi(r);let s;const i=n.Tu.get(t);return i?(n.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.lu()):s=await Yd(n,t,e,!0),s}async function c_(r,t){const e=Oi(r);await Yd(e,t,!0,!1)}async function Yd(r,t,e,n){const s=await Xn(r.localStore,Dt(t)),i=s.targetId,a=r.sharedClientState.addLocalQueryTarget(i,e);let u;return n&&(u=await Ba(r,t,i,a==="current",s.resumeToken)),r.isPrimaryClient&&e&&Fi(r.remoteStore,s),u}async function Ba(r,t,e,n,s){r.pu=(m,p,v)=>(async function(N,D,q,j){let U=D.view.ru(q);U.bs&&(U=await gi(N.localStore,D.query,!1).then((({documents:T})=>D.view.ru(T,U))));const X=j&&j.targetChanges.get(D.targetId),J=j&&j.targetMismatches.get(D.targetId)!=null,Y=D.view.applyChanges(U,N.isPrimaryClient,X,J);return Xo(N,D.targetId,Y.au),Y.snapshot})(r,m,p,v);const i=await gi(r.localStore,t,!0),a=new Jd(t,i.ks),u=a.ru(i.documents),c=_s.createSynthesizedTargetChangeForCurrentChange(e,n&&r.onlineState!=="Offline",s),h=a.applyChanges(u,r.isPrimaryClient,c);Xo(r,e,h.au);const f=new i_(t,e,a);return r.Tu.set(t,f),r.Eu.has(e)?r.Eu.get(e).push(t):r.Eu.set(e,[t]),h.snapshot}async function l_(r,t,e){const n=M(r),s=n.Tu.get(t),i=n.Eu.get(s.targetId);if(i.length>1)return n.Eu.set(s.targetId,i.filter((a=>!fs(a,t)))),void n.Tu.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(s.targetId),n.sharedClientState.isActiveQueryTarget(s.targetId)||await Zn(n.localStore,s.targetId,!1).then((()=>{n.sharedClientState.clearQueryState(s.targetId),e&&tr(n.remoteStore,s.targetId),er(n,s.targetId)})).catch(Oe)):(er(n,s.targetId),await Zn(n.localStore,s.targetId,!0))}async function h_(r,t){const e=M(r),n=e.Tu.get(t),s=e.Eu.get(n.targetId);e.isPrimaryClient&&s.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),tr(e.remoteStore,n.targetId))}async function d_(r,t,e){const n=Ga(r);try{const s=await(function(a,u){const c=M(a),h=Z.now(),f=u.reduce(((v,C)=>v.add(C.key)),G());let m,p;return c.persistence.runTransaction("Locally write mutations","readwrite",(v=>{let C=Lt(),N=G();return c.xs.getEntries(v,f).next((D=>{C=D,C.forEach(((q,j)=>{j.isValidDocument()||(N=N.add(q))}))})).next((()=>c.localDocuments.getOverlayedDocuments(v,C))).next((D=>{m=D;const q=[];for(const j of u){const U=Mg(j,m.get(j.key).overlayedDocument);U!=null&&q.push(new de(j.key,U,Ah(U.value.mapValue),lt.exists(!0)))}return c.mutationQueue.addMutationBatch(v,h,q,u)})).next((D=>{p=D;const q=D.applyToLocalDocumentSet(m,N);return c.documentOverlayCache.saveOverlays(v,D.batchId,q)}))})).then((()=>({batchId:p.batchId,changes:Lh(m)})))})(n.localStore,t);n.sharedClientState.addPendingMutation(s.batchId),(function(a,u,c){let h=a.du[a.currentUser.toKey()];h||(h=new it(z)),h=h.insert(u,c),a.du[a.currentUser.toKey()]=h})(n,s.batchId,e),await fe(n,s.changes),await cr(n.remoteStore)}catch(s){const i=hr(s,"Failed to persist write");e.reject(i)}}async function Xd(r,t){const e=M(r);try{const n=await bp(e.localStore,t);t.targetChanges.forEach(((s,i)=>{const a=e.Au.get(i);a&&(L(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.hu=!0:s.modifiedDocuments.size>0?L(a.hu,14607):s.removedDocuments.size>0&&(L(a.hu,42227),a.hu=!1))})),await fe(e,n,t)}catch(n){await Oe(n)}}function yl(r,t,e){const n=M(r);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const s=[];n.Tu.forEach(((i,a)=>{const u=a.view.va(t);u.snapshot&&s.push(u.snapshot)})),(function(a,u){const c=M(a);c.onlineState=u;let h=!1;c.queries.forEach(((f,m)=>{for(const p of m.Sa)p.va(u)&&(h=!0)})),h&&Oa(c)})(n.eventManager,t),s.length&&n.Pu.H_(s),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function f_(r,t,e){const n=M(r);n.sharedClientState.updateQueryState(t,"rejected",e);const s=n.Au.get(t),i=s&&s.key;if(i){let a=new it(k.comparator);a=a.insert(i,at.newNoDocument(i,B.min()));const u=G().add(i),c=new ps(B.min(),new Map,new it(z),a,u);await Xd(n,c),n.Ru=n.Ru.remove(i),n.Au.delete(t),za(n)}else await Zn(n.localStore,t,!1).then((()=>er(n,t,e))).catch(Oe)}async function m_(r,t){const e=M(r),n=t.batch.batchId;try{const s=await Vp(e.localStore,t);ja(e,n,null),Ua(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await fe(e,s)}catch(s){await Oe(s)}}async function g_(r,t,e){const n=M(r);try{const s=await(function(a,u){const c=M(a);return c.persistence.runTransaction("Reject batch","readwrite-primary",(h=>{let f;return c.mutationQueue.lookupMutationBatch(h,u).next((m=>(L(m!==null,37113),f=m.keys(),c.mutationQueue.removeMutationBatch(h,m)))).next((()=>c.mutationQueue.performConsistencyCheck(h))).next((()=>c.documentOverlayCache.removeOverlaysForBatchId(h,f,u))).next((()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,f))).next((()=>c.localDocuments.getDocuments(h,f)))}))})(n.localStore,t);ja(n,t,e),Ua(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await fe(n,s)}catch(s){await Oe(s)}}async function p_(r,t){const e=M(r);Be(e.remoteStore)||x(Ue,"The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");try{const n=await(function(a){const u=M(a);return u.persistence.runTransaction("Get highest unacknowledged batch id","readonly",(c=>u.mutationQueue.getHighestUnacknowledgedBatchId(c)))})(e.localStore);if(n===be)return void t.resolve();const s=e.mu.get(n)||[];s.push(t),e.mu.set(n,s)}catch(n){const s=hr(n,"Initialization of waitForPendingWrites() operation failed");t.reject(s)}}function Ua(r,t){(r.mu.get(t)||[]).forEach((e=>{e.resolve()})),r.mu.delete(t)}function ja(r,t,e){const n=M(r);let s=n.du[n.currentUser.toKey()];if(s){const i=s.get(t);i&&(e?i.reject(e):i.resolve(),s=s.remove(t)),n.du[n.currentUser.toKey()]=s}}function er(r,t,e=null){r.sharedClientState.removeLocalQueryTarget(t);for(const n of r.Eu.get(t))r.Tu.delete(n),e&&r.Pu.yu(n,e);r.Eu.delete(t),r.isPrimaryClient&&r.Vu.Gr(t).forEach((n=>{r.Vu.containsKey(n)||Zd(r,n)}))}function Zd(r,t){r.Iu.delete(t.path.canonicalString());const e=r.Ru.get(t);e!==null&&(tr(r.remoteStore,e),r.Ru=r.Ru.remove(t),r.Au.delete(e),za(r))}function Xo(r,t,e){for(const n of e)n instanceof Wd?(r.Vu.addReference(n.key,t),__(r,n)):n instanceof Hd?(x(Ue,"Document no longer in limbo: "+n.key),r.Vu.removeReference(n.key,t),r.Vu.containsKey(n.key)||Zd(r,n.key)):O(19791,{wu:n})}function __(r,t){const e=t.key,n=e.path.canonicalString();r.Ru.get(e)||r.Iu.has(n)||(x(Ue,"New document in limbo: "+e),r.Iu.add(n),za(r))}function za(r){for(;r.Iu.size>0&&r.Ru.size<r.maxConcurrentLimboResolutions;){const t=r.Iu.values().next().value;r.Iu.delete(t);const e=new k($.fromString(t)),n=r.fu.next();r.Au.set(n,new o_(e)),r.Ru=r.Ru.insert(e,n),Fi(r.remoteStore,new oe(Dt(ir(e.path)),n,"TargetPurposeLimboResolution",Ft.ce))}}async function fe(r,t,e){const n=M(r),s=[],i=[],a=[];n.Tu.isEmpty()||(n.Tu.forEach(((u,c)=>{a.push(n.pu(c,t,e).then((h=>{var f;if((h||e)&&n.isPrimaryClient){const m=h?!h.fromCache:(f=e==null?void 0:e.targetChanges.get(c.targetId))==null?void 0:f.current;n.sharedClientState.updateQueryState(c.targetId,m?"current":"not-current")}if(h){s.push(h);const m=Sa.Is(c.targetId,h);i.push(m)}})))})),await Promise.all(a),n.Pu.H_(s),await(async function(c,h){const f=M(c);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",(m=>A.forEach(h,(p=>A.forEach(p.Ts,(v=>f.persistence.referenceDelegate.addReference(m,p.targetId,v))).next((()=>A.forEach(p.Es,(v=>f.persistence.referenceDelegate.removeReference(m,p.targetId,v)))))))))}catch(m){if(!Le(m))throw m;x(Va,"Failed to update sequence numbers: "+m)}for(const m of h){const p=m.targetId;if(!m.fromCache){const v=f.vs.get(p),C=v.snapshotVersion,N=v.withLastLimboFreeSnapshotVersion(C);f.vs=f.vs.insert(p,N)}}})(n.localStore,i))}async function y_(r,t){const e=M(r);if(!e.currentUser.isEqual(t)){x(Ue,"User change. New user:",t.toKey());const n=await bd(e.localStore,t);e.currentUser=t,(function(i,a){i.mu.forEach((u=>{u.forEach((c=>{c.reject(new b(P.CANCELLED,a))}))})),i.mu.clear()})(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await fe(e,n.Ns)}}function I_(r,t){const e=M(r),n=e.Au.get(t);if(n&&n.hu)return G().add(n.key);{let s=G();const i=e.Eu.get(t);if(!i)return s;for(const a of i){const u=e.Tu.get(a);s=s.unionWith(u.view.nu)}return s}}async function T_(r,t){const e=M(r),n=await gi(e.localStore,t.query,!0),s=t.view.cu(n);return e.isPrimaryClient&&Xo(e,t.targetId,s.au),s}async function E_(r,t){const e=M(r);return Nd(e.localStore,t).then((n=>fe(e,n)))}async function w_(r,t,e,n){const s=M(r),i=await(function(u,c){const h=M(u),f=M(h.mutationQueue);return h.persistence.runTransaction("Lookup mutation documents","readonly",(m=>f.Xn(m,c).next((p=>p?h.localDocuments.getDocuments(m,p):A.resolve(null)))))})(s.localStore,t);i!==null?(e==="pending"?await cr(s.remoteStore):e==="acknowledged"||e==="rejected"?(ja(s,t,n||null),Ua(s,t),(function(u,c){M(M(u).mutationQueue).nr(c)})(s.localStore,t)):O(6720,"Unknown batchState",{Su:e}),await fe(s,i)):x(Ue,"Cannot apply mutation batch with id: "+t)}async function A_(r,t){const e=M(r);if(Oi(e),Ga(e),t===!0&&e.gu!==!0){const n=e.sharedClientState.getAllActiveQueryTargets(),s=await Il(e,n.toArray());e.gu=!0,await Jo(e.remoteStore,!0);for(const i of s)Fi(e.remoteStore,i)}else if(t===!1&&e.gu!==!1){const n=[];let s=Promise.resolve();e.Eu.forEach(((i,a)=>{e.sharedClientState.isLocalQueryTarget(a)?n.push(a):s=s.then((()=>(er(e,a),Zn(e.localStore,a,!0)))),tr(e.remoteStore,a)})),await s,await Il(e,n),(function(a){const u=M(a);u.Au.forEach(((c,h)=>{tr(u.remoteStore,h)})),u.Vu.zr(),u.Au=new Map,u.Ru=new it(k.comparator)})(e),e.gu=!1,await Jo(e.remoteStore,!1)}}async function Il(r,t,e){const n=M(r),s=[],i=[];for(const a of t){let u;const c=n.Eu.get(a);if(c&&c.length!==0){u=await Xn(n.localStore,Dt(c[0]));for(const h of c){const f=n.Tu.get(h),m=await T_(n,f);m.snapshot&&i.push(m.snapshot)}}else{const h=await Dd(n.localStore,a);u=await Xn(n.localStore,h),await Ba(n,tf(h),a,!1,u.resumeToken)}s.push(u)}return n.Pu.H_(i),s}function tf(r){return xh(r.path,r.collectionGroup,r.orderBy,r.filters,r.limit,"F",r.startAt,r.endAt)}function v_(r){return(function(e){return M(M(e).persistence).hs()})(M(r).localStore)}async function R_(r,t,e,n){const s=M(r);if(s.gu)return void x(Ue,"Ignoring unexpected query state notification.");const i=s.Eu.get(t);if(i&&i.length>0)switch(e){case"current":case"not-current":{const a=await Nd(s.localStore,Mh(i[0])),u=ps.createSynthesizedRemoteEventForCurrentChange(t,e==="current",ft.EMPTY_BYTE_STRING);await fe(s,a,u);break}case"rejected":await Zn(s.localStore,t,!0),er(s,t,n);break;default:O(64155,e)}}async function P_(r,t,e){const n=Oi(r);if(n.gu){for(const s of t){if(n.Eu.has(s)&&n.sharedClientState.isActiveQueryTarget(s)){x(Ue,"Adding an already active target "+s);continue}const i=await Dd(n.localStore,s),a=await Xn(n.localStore,i);await Ba(n,tf(i),a.targetId,!1,a.resumeToken),Fi(n.remoteStore,a)}for(const s of e)n.Eu.has(s)&&await Zn(n.localStore,s,!1).then((()=>{tr(n.remoteStore,s),er(n,s)})).catch(Oe)}}function Oi(r){const t=M(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=Xd.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=I_.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=f_.bind(null,t),t.Pu.H_=r_.bind(null,t.eventManager),t.Pu.yu=s_.bind(null,t.eventManager),t}function Ga(r){const t=M(r);return t.remoteStore.remoteSyncer.applySuccessfulWrite=m_.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=g_.bind(null,t),t}function S_(r,t,e){const n=M(r);(async function(i,a,u){try{const c=await a.getMetadata();if(await(function(v,C){const N=M(v),D=gt(C.createTime);return N.persistence.runTransaction("hasNewerBundle","readonly",(q=>N.Pi.getBundleMetadata(q,C.id))).then((q=>!!q&&q.createTime.compareTo(D)>=0))})(i.localStore,c))return await a.close(),u._completeWith((function(v){return{taskState:"Success",documentsLoaded:v.totalDocuments,bytesLoaded:v.totalBytes,totalDocuments:v.totalDocuments,totalBytes:v.totalBytes}})(c)),Promise.resolve(new Set);u._updateProgress(Qd(c));const h=new qa(c,a.serializer);let f=await a.bu();for(;f;){const p=await h.Ga(f);p&&u._updateProgress(p),f=await a.bu()}const m=await h.ja(i.localStore);return await fe(i,m.Ha,void 0),await(function(v,C){const N=M(v);return N.persistence.runTransaction("Save bundle","readwrite",(D=>N.Pi.saveBundleMetadata(D,C)))})(i.localStore,c),u._completeWith(m.progress),Promise.resolve(m.Ja)}catch(c){return Gt(Ue,`Loading bundle failed with ${c}`),u._failWith(c),Promise.resolve(new Set)}})(n,t,e).then((s=>{n.sharedClientState.notifyBundleLoaded(s)}))}class nr{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=yn(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,e){return null}Mu(t,e){return null}vu(t){return Vd(this.persistence,new Sd,t.initialUser,this.serializer)}Cu(t){return new va(Mi.Vi,this.serializer)}Du(t){return new Ld}async terminate(){var t,e;(t=this.gcScheduler)==null||t.stop(),(e=this.indexBackfillerScheduler)==null||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}nr.provider={build:()=>new nr};class Ka extends nr{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,e){L(this.persistence.referenceDelegate instanceof mi,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new Ed(n,t.asyncQueue,e)}Cu(t){const e=this.cacheSizeBytes!==void 0?Ct.withCacheSize(this.cacheSizeBytes):Ct.DEFAULT;return new va((n=>mi.Vi(n,e)),this.serializer)}}class $a extends nr{constructor(t,e,n){super(),this.xu=t,this.cacheSizeBytes=e,this.forceOwnership=n,this.kind="persistent",this.synchronizeTabs=!1}async initialize(t){await super.initialize(t),await this.xu.initialize(this,t),await Ga(this.xu.syncEngine),await cr(this.xu.remoteStore),await this.persistence.zi((()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve())))}vu(t){return Vd(this.persistence,new Sd,t.initialUser,this.serializer)}Fu(t,e){const n=this.persistence.referenceDelegate.garbageCollector;return new Ed(n,t.asyncQueue,e)}Mu(t,e){const n=new Mm(e,this.persistence);return new km(t.asyncQueue,n)}Cu(t){const e=Pa(t.databaseInfo.databaseId,t.databaseInfo.persistenceKey),n=this.cacheSizeBytes!==void 0?Ct.withCacheSize(this.cacheSizeBytes):Ct.DEFAULT;return new Ra(this.synchronizeTabs,e,t.clientId,n,t.asyncQueue,qd(),ni(),this.serializer,this.sharedClientState,!!this.forceOwnership)}Du(t){return new Ld}}class ef extends $a{constructor(t,e){super(t,e,!1),this.xu=t,this.cacheSizeBytes=e,this.synchronizeTabs=!0}async initialize(t){await super.initialize(t);const e=this.xu.syncEngine;this.sharedClientState instanceof Ao&&(this.sharedClientState.syncEngine={bo:w_.bind(null,e),Do:R_.bind(null,e),Co:P_.bind(null,e),hs:v_.bind(null,e),So:E_.bind(null,e)},await this.sharedClientState.start()),await this.persistence.zi((async n=>{await A_(this.xu.syncEngine,n),this.gcScheduler&&(n&&!this.gcScheduler.started?this.gcScheduler.start():n||this.gcScheduler.stop()),this.indexBackfillerScheduler&&(n&&!this.indexBackfillerScheduler.started?this.indexBackfillerScheduler.start():n||this.indexBackfillerScheduler.stop())}))}Du(t){const e=qd();if(!Ao.v(e))throw new b(P.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.");const n=Pa(t.databaseInfo.databaseId,t.databaseInfo.persistenceKey);return new Ao(e,t.asyncQueue,n,t.clientId,t.initialUser)}}class Me{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>yl(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=y_.bind(null,this.syncEngine),await Jo(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new n_})()}createDatastore(t){const e=yn(t.databaseInfo.databaseId),n=Op(t.databaseInfo);return jp(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return(function(n,s,i,a,u){return new Gp(n,s,i,a,u)})(this.localStore,this.datastore,t.asyncQueue,(e=>yl(this.syncEngine,e,0)),(function(){return hl.v()?new hl:new Np})())}createSyncEngine(t,e){return(function(s,i,a,u,c,h,f){const m=new a_(s,i,a,u,c,h);return f&&(m.gu=!0),m})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await(async function(s){const i=M(s);x(gn,"RemoteStore shutting down."),i.Ia.add(5),await ur(i),i.Aa.shutdown(),i.Va.set("Unknown")})(this.remoteStore),(t=this.datastore)==null||t.terminate(),(e=this.eventManager)==null||e.terminate()}}Me.provider={build:()=>new Me};function Tl(r,t=10240){let e=0;return{async read(){if(e<r.byteLength){const n={value:r.slice(e,e+t),done:!1};return e+=t,n}return{done:!0}},async cancel(){},releaseLock(){},closed:Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class V_{constructor(t,e){this.Bu=t,this.serializer=e,this.metadata=new Rt,this.buffer=new Uint8Array,this.Lu=(function(){return new TextDecoder("utf-8")})(),this.ku().then((n=>{n&&n.Ua()?this.metadata.resolve(n.Ka.metadata):this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(n==null?void 0:n.Ka)}`))}),(n=>this.metadata.reject(n)))}close(){return this.Bu.cancel()}async getMetadata(){return this.metadata.promise}async bu(){return await this.getMetadata(),this.ku()}async ku(){const t=await this.qu();if(t===null)return null;const e=this.Lu.decode(t),n=Number(e);isNaN(n)&&this.Ku(`length string (${e}) is not valid number`);const s=await this.Uu(n);return new $d(JSON.parse(s),t.length+n)}$u(){return this.buffer.findIndex((t=>t===123))}async qu(){for(;this.$u()<0&&!await this.Wu(););if(this.buffer.length===0)return null;const t=this.$u();t<0&&this.Ku("Reached the end of bundle when a length string is expected.");const e=this.buffer.slice(0,t);return this.buffer=this.buffer.slice(t),e}async Uu(t){for(;this.buffer.length<t;)await this.Wu()&&this.Ku("Reached the end of bundle when more is expected.");const e=this.Lu.decode(this.buffer.slice(0,t));return this.buffer=this.buffer.slice(t),e}Ku(t){throw this.Bu.cancel(),new Error(`Invalid bundle format: ${t}`)}async Wu(){const t=await this.Bu.read();if(!t.done){const e=new Uint8Array(this.buffer.length+t.value.length);e.set(this.buffer),e.set(t.value,this.buffer.length),this.buffer=e}return t.done}}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b_{constructor(t,e){this.bundleData=t,this.serializer=e,this.cursor=0,this.elements=[];let n=this.bu();if(!n||!n.Ua())throw new Error(`The first element of the bundle is not a metadata object, it is
         ${JSON.stringify(n==null?void 0:n.Ka)}`);this.metadata=n;do n=this.bu(),n!==null&&this.elements.push(n);while(n!==null)}getMetadata(){return this.metadata}Qu(){return this.elements}bu(){if(this.cursor===this.bundleData.length)return null;const t=this.qu(),e=this.Uu(t);return new $d(JSON.parse(e),t)}Uu(t){if(this.cursor+t>this.bundleData.length)throw new b(P.INTERNAL,"Reached the end of bundle when more is expected.");return this.bundleData.slice(this.cursor,this.cursor+=t)}qu(){const t=this.cursor;let e=this.cursor;for(;e<this.bundleData.length;){if(this.bundleData[e]==="{"){if(e===t)throw new Error("First character is a bracket and not a number");return this.cursor=e,Number(this.bundleData.slice(t,e))}e++}throw new Error("Reached the end of bundle when more is expected.")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x_{constructor(t,e,n,s,i){this.asyncQueue=t,this.datastore=e,this.options=n,this.updateFunction=s,this.deferred=i,this.zu=n.maxAttempts,this.M_=new Ca(this.asyncQueue,"transaction_retry")}ju(){this.zu-=1,this.Ju()}Ju(){this.M_.p_((async()=>{const t=new C_(this.datastore),e=this.Hu(t);e&&e.then((n=>{this.asyncQueue.enqueueAndForget((()=>t.commit().then((()=>{this.deferred.resolve(n)})).catch((s=>{this.Zu(s)}))))})).catch((n=>{this.Zu(n)}))}))}Hu(t){try{const e=this.updateFunction(t);return!ls(e)&&e.catch&&e.then?e:(this.deferred.reject(Error("Transaction callback must return a Promise")),null)}catch(e){return this.deferred.reject(e),null}}Zu(t){this.zu>0&&this.Xu(t)?(this.zu-=1,this.asyncQueue.enqueueAndForget((()=>(this.Ju(),Promise.resolve())))):this.deferred.reject(t)}Xu(t){if((t==null?void 0:t.name)==="FirebaseError"){const e=t.code;return e==="aborted"||e==="failed-precondition"||e==="already-exists"||!Hh(e)}return!1}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe="FirestoreClient";class D_{constructor(t,e,n,s,i){this.authCredentials=t,this.appCheckCredentials=e,this.asyncQueue=n,this._databaseInfo=s,this.user=At.UNAUTHENTICATED,this.clientId=ea.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=i,this.authCredentials.start(n,(async a=>{x(Fe,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a})),this.appCheckCredentials.start(n,(a=>(x(Fe,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user))))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this._databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(t){this.authCredentialListener=t}setAppCheckTokenChangeListener(t){this.appCheckCredentialListener=t}terminate(){this.asyncQueue.enterRestrictedMode();const t=new Rt;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),t.resolve()}catch(e){const n=hr(e,"Failed to shutdown persistence");t.reject(n)}})),t.promise}}async function Ro(r,t){r.asyncQueue.verifyOperationInProgress(),x(Fe,"Initializing OfflineComponentProvider");const e=r.configuration;await t.initialize(e);let n=e.initialUser;r.setCredentialChangeListener((async s=>{n.isEqual(s)||(await bd(t.localStore,s),n=s)})),t.persistence.setDatabaseDeletedListener((()=>r.terminate())),r._offlineComponents=t}async function El(r,t){r.asyncQueue.verifyOperationInProgress();const e=await Qa(r);x(Fe,"Initializing OnlineComponentProvider"),await t.initialize(e,r.configuration),r.setCredentialChangeListener((n=>fl(t.remoteStore,n))),r.setAppCheckTokenChangeListener(((n,s)=>fl(t.remoteStore,s))),r._onlineComponents=t}async function Qa(r){if(!r._offlineComponents)if(r._uninitializedComponentsProvider){x(Fe,"Using user provided OfflineComponentProvider");try{await Ro(r,r._uninitializedComponentsProvider._offline)}catch(t){const e=t;if(!(function(s){return s.name==="FirebaseError"?s.code===P.FAILED_PRECONDITION||s.code===P.UNIMPLEMENTED:!(typeof DOMException<"u"&&s instanceof DOMException)||s.code===22||s.code===20||s.code===11})(e))throw e;Gt("Error using user provided cache. Falling back to memory cache: "+e),await Ro(r,new nr)}}else x(Fe,"Using default OfflineComponentProvider"),await Ro(r,new Ka(void 0));return r._offlineComponents}async function qi(r){return r._onlineComponents||(r._uninitializedComponentsProvider?(x(Fe,"Using user provided OnlineComponentProvider"),await El(r,r._uninitializedComponentsProvider._online)):(x(Fe,"Using default OnlineComponentProvider"),await El(r,new Me))),r._onlineComponents}function nf(r){return Qa(r).then((t=>t.persistence))}function dr(r){return Qa(r).then((t=>t.localStore))}function rf(r){return qi(r).then((t=>t.remoteStore))}function Wa(r){return qi(r).then((t=>t.syncEngine))}function sf(r){return qi(r).then((t=>t.datastore))}async function rr(r){const t=await qi(r),e=t.eventManager;return e.onListen=u_.bind(null,t.syncEngine),e.onUnlisten=l_.bind(null,t.syncEngine),e.onFirstRemoteStoreListen=c_.bind(null,t.syncEngine),e.onLastRemoteStoreUnlisten=h_.bind(null,t.syncEngine),e}function N_(r){return r.asyncQueue.enqueue((async()=>{const t=await nf(r),e=await rf(r);return t.setNetworkEnabled(!0),(function(s){const i=M(s);return i.Ia.delete(0),ys(i)})(e)}))}function k_(r){return r.asyncQueue.enqueue((async()=>{const t=await nf(r),e=await rf(r);return t.setNetworkEnabled(!1),(async function(s){const i=M(s);i.Ia.add(0),await ur(i),i.Va.set("Offline")})(e)}))}function M_(r,t,e,n){const s=new Li(n),i=new La(t,s,e);return r.asyncQueue.enqueueAndForget((async()=>Ma(await rr(r),i))),()=>{s.Nu(),r.asyncQueue.enqueueAndForget((async()=>Fa(await rr(r),i)))}}function F_(r,t){const e=new Rt;return r.asyncQueue.enqueueAndForget((async()=>(async function(s,i,a){try{const u=await(function(h,f){const m=M(h);return m.persistence.runTransaction("read document","readonly",(p=>m.localDocuments.getDocument(p,f)))})(s,i);u.isFoundDocument()?a.resolve(u):u.isNoDocument()?a.resolve(null):a.reject(new b(P.UNAVAILABLE,"Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"))}catch(u){const c=hr(u,`Failed to get document '${i} from cache`);a.reject(c)}})(await dr(r),t,e))),e.promise}function of(r,t,e={}){const n=new Rt;return r.asyncQueue.enqueueAndForget((async()=>(function(i,a,u,c,h){const f=new Li({next:p=>{f.Nu(),a.enqueueAndForget((()=>Fa(i,m)));const v=p.docs.has(u);!v&&p.fromCache?h.reject(new b(P.UNAVAILABLE,"Failed to get document because the client is offline.")):v&&p.fromCache&&c&&c.source==="server"?h.reject(new b(P.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):h.resolve(p)},error:p=>h.reject(p)}),m=new La(ir(u.path),f,{includeMetadataChanges:!0,qa:!0});return Ma(i,m)})(await rr(r),r.asyncQueue,t,e,n))),n.promise}function O_(r,t){const e=new Rt;return r.asyncQueue.enqueueAndForget((async()=>(async function(s,i,a){try{const u=await gi(s,i,!0),c=new Jd(i,u.ks),h=c.ru(u.documents),f=c.applyChanges(h,!1);a.resolve(f.snapshot)}catch(u){const c=hr(u,`Failed to execute query '${i} against cache`);a.reject(c)}})(await dr(r),t,e))),e.promise}function af(r,t,e={}){const n=new Rt;return r.asyncQueue.enqueueAndForget((async()=>(function(i,a,u,c,h){const f=new Li({next:p=>{f.Nu(),a.enqueueAndForget((()=>Fa(i,m))),p.fromCache&&c.source==="server"?h.reject(new b(P.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):h.resolve(p)},error:p=>h.reject(p)}),m=new La(u,f,{includeMetadataChanges:!0,qa:!0});return Ma(i,m)})(await rr(r),r.asyncQueue,t,e,n))),n.promise}function L_(r,t,e){const n=new Rt;return r.asyncQueue.enqueueAndForget((async()=>{try{const s=await sf(r);n.resolve((async function(a,u,c){var N;const h=M(a),{request:f,gt:m,parent:p}=od(h.serializer,Dh(u),c);h.connection.qo||delete f.parent;const v=(await h.jo("RunAggregationQuery",h.serializer.databaseId,p,f,1)).filter((D=>!!D.result));L(v.length===1,64727);const C=(N=v[0].result)==null?void 0:N.aggregateFields;return Object.keys(C).reduce(((D,q)=>(D[m[q]]=C[q],D)),{})})(s,t,e))}catch(s){n.reject(s)}})),n.promise}function q_(r,t){const e=new Rt;return r.asyncQueue.enqueueAndForget((async()=>d_(await Wa(r),t,e))),e.promise}function B_(r,t){const e=new Li(t);return r.asyncQueue.enqueueAndForget((async()=>(function(s,i){M(s).Ca.add(i),i.next()})(await rr(r),e))),()=>{e.Nu(),r.asyncQueue.enqueueAndForget((async()=>(function(s,i){M(s).Ca.delete(i)})(await rr(r),e)))}}function U_(r,t,e){const n=new Rt;return r.asyncQueue.enqueueAndForget((async()=>{const s=await sf(r);new x_(r.asyncQueue,s,e,t,n).ju()})),n.promise}function j_(r,t,e,n){const s=(function(a,u){let c;return c=typeof a=="string"?Yh().encode(a):a,(function(f,m){return new V_(f,m)})((function(f,m){if(f instanceof Uint8Array)return Tl(f,m);if(f instanceof ArrayBuffer)return Tl(new Uint8Array(f),m);if(f instanceof ReadableStream)return f.getReader();throw new Error("Source of `toByteStreamReader` has to be a ArrayBuffer or ReadableStream")})(c),u)})(e,yn(t));r.asyncQueue.enqueueAndForget((async()=>{S_(await Wa(r),s,n)}))}function z_(r,t){return r.asyncQueue.enqueue((async()=>(function(n,s){const i=M(n);return i.persistence.runTransaction("Get named query","readonly",(a=>i.Pi.getNamedQuery(a,s)))})(await dr(r),t)))}function uf(r,t){return(function(n,s){return new b_(n,s)})(r,t)}function G_(r,t){return r.asyncQueue.enqueue((async()=>(async function(n,s){const i=M(n),a=i.indexManager,u=[];return i.persistence.runTransaction("Configure indexes","readwrite",(c=>a.getFieldIndexes(c).next((h=>(function(m,p,v,C,N){m=[...m],p=[...p],m.sort(v),p.sort(v);const D=m.length,q=p.length;let j=0,U=0;for(;j<q&&U<D;){const X=v(m[U],p[j]);X<0?N(m[U++]):X>0?C(p[j++]):(j++,U++)}for(;j<q;)C(p[j++]);for(;U<D;)N(m[U++])})(h,s,Cm,(f=>{u.push(a.addFieldIndex(c,f))}),(f=>{u.push(a.deleteFieldIndex(c,f))})))).next((()=>A.waitFor(u)))))})(await dr(r),t)))}function K_(r,t){return r.asyncQueue.enqueue((async()=>(function(n,s){M(n).Cs.As=s})(await dr(r),t)))}function $_(r){return r.asyncQueue.enqueue((async()=>(function(e){const n=M(e),s=n.indexManager;return n.persistence.runTransaction("Delete All Indexes","readwrite",(i=>s.deleteAllFieldIndexes(i)))})(await dr(r))))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q_="ComponentProvider",wl=new Map;function W_(r,t,e,n,s){return new cg(r,t,e,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,cf(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cy=-1;class st extends Is{constructor(t,e,n,s){super(t,e,n,s),this.type="firestore",this._queue=new Pl,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Pl(t),this._firestoreClient=void 0,await t}}}function xy(r,t,e){e||(e=es);const n=Ol(r,"firestore");if(n.isInitialized(e)){const s=n.getImmediate({identifier:e}),i=n.getOptions(e);if(cs(i,t))return s;throw new b(P.FAILED_PRECONDITION,"initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.")}if(t.cacheSizeBytes!==void 0&&t.localCache!==void 0)throw new b(P.INVALID_ARGUMENT,"cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");if(t.cacheSizeBytes!==void 0&&t.cacheSizeBytes!==-1&&t.cacheSizeBytes<Td)throw new b(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");return t.host&&Zo(t.host)&&Fl(t.host),n.initialize({options:t,instanceIdentifier:e})}function Dy(r,t){const e=typeof r=="object"?r:cm(),n=typeof r=="string"?r:t||es,s=Ol(e,"firestore").getImmediate({identifier:n});if(!s._initialized){const i=lm("firestore");i&&H_(s,...i)}return s}function ht(r){if(r._terminated)throw new b(P.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||df(r),r._firestoreClient}function df(r){var n,s,i,a;const t=r._freezeSettings(),e=W_(r._databaseId,((n=r._app)==null?void 0:n.options.appId)||"",r._persistenceKey,(s=r._app)==null?void 0:s.options.apiKey,t);r._componentsProvider||(i=t.localCache)!=null&&i._offlineComponentProvider&&((a=t.localCache)!=null&&a._onlineComponentProvider)&&(r._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),r._firestoreClient=new D_(r._authCredentials,r._appCheckCredentials,r._queue,e,r._componentsProvider&&(function(c){const h=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(h),_online:h}})(r._componentsProvider))}function Ny(r,t){Gt("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const e=r._freezeSettings();return ff(r,Me.provider,{build:n=>new $a(n,e.cacheSizeBytes,t==null?void 0:t.forceOwnership)}),Promise.resolve()}async function ky(r){Gt("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const t=r._freezeSettings();ff(r,Me.provider,{build:e=>new ef(e,t.cacheSizeBytes)})}function ff(r,t,e){if((r=Q(r,st))._firestoreClient||r._terminated)throw new b(P.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");if(r._componentsProvider||r._getSettings().localCache)throw new b(P.FAILED_PRECONDITION,"SDK cache is already specified.");r._componentsProvider={_online:t,_offline:e},df(r)}function My(r){if(r._initialized&&!r._terminated)throw new b(P.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const t=new Rt;return r._queue.enqueueAndForgetEvenWhileRestricted((async()=>{try{await(async function(n){if(!te.v())return Promise.resolve();const s=n+Pd;await te.delete(s)})(Pa(r._databaseId,r._persistenceKey)),t.resolve()}catch(e){t.reject(e)}})),t.promise}function Fy(r){return(function(e){const n=new Rt;return e.asyncQueue.enqueueAndForget((async()=>p_(await Wa(e),n))),n.promise})(ht(r=Q(r,st)))}function Oy(r){return N_(ht(r=Q(r,st)))}function Ly(r){return k_(ht(r=Q(r,st)))}function qy(r){return hm(r.app,"firestore",r._databaseId.database),r._delete()}function Vl(r,t){const e=ht(r=Q(r,st)),n=new Y_;return j_(e,r._databaseId,t,n),n}function X_(r,t){return z_(ht(r=Q(r,st)),t).then((e=>e?new Pt(r,null,e.query):null))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fr{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new b(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ct(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}function By(){return new fr(bo)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z_=/^__.*__$/;class ty{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return this.fieldMask!==null?new de(t,this.data,this.fieldMask,e,this.fieldTransforms):new or(t,this.data,e,this.fieldTransforms)}}class mf{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new de(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function gf(r){switch(r){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw O(40011,{dataSource:r})}}class Bi{constructor(t,e,n,s,i,a){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=s,i===void 0&&this.Ac(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(t){return new Bi({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(t){var s;const e=(s=this.path)==null?void 0:s.child(t),n=this.i({path:e,arrayElement:!1});return n.mc(t),n}fc(t){var s;const e=(s=this.path)==null?void 0:s.child(t),n=this.i({path:e,arrayElement:!1});return n.Ac(),n}gc(t){return this.i({path:void 0,arrayElement:!0})}yc(t){return Ii(t,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(t){return this.fieldMask.find((e=>t.isPrefixOf(e)))!==void 0||this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))!==void 0}Ac(){if(this.path)for(let t=0;t<this.path.length;t++)this.mc(this.path.get(t))}mc(t){if(t.length===0)throw this.yc("Document fields must not be empty");if(gf(this.dataSource)&&Z_.test(t))throw this.yc('Document fields cannot begin and end with "__"')}}class ey{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||yn(t)}I(t,e,n,s=!1){return new Bi({dataSource:t,methodName:e,targetDoc:n,path:ct.emptyPath(),arrayElement:!1,hasConverter:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Tn(r){const t=r._freezeSettings(),e=yn(r._databaseId);return new ey(r._databaseId,!!t.ignoreUndefinedProperties,e)}function Ui(r,t,e,n,s,i={}){const a=r.I(i.merge||i.mergeFields?2:0,t,e,s);eu("Data must be an object, but it was:",a,n);const u=yf(n,a);let c,h;if(i.merge)c=new Ot(a.fieldMask),h=a.fieldTransforms;else if(i.mergeFields){const f=[];for(const m of i.mergeFields){const p=ce(t,m,e);if(!a.contains(p))throw new b(P.INVALID_ARGUMENT,`Field '${p}' is specified in your field mask but missing from your input data.`);Tf(f,p)||f.push(p)}c=new Ot(f),h=a.fieldTransforms.filter((m=>c.covers(m.field)))}else c=null,h=a.fieldTransforms;return new ty(new vt(u),c,h)}class Ts extends In{_toFieldTransform(t){if(t.dataSource!==2)throw t.dataSource===1?t.yc(`${this._methodName}() can only appear at the top level of your update data`):t.yc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Ts}}function pf(r,t,e){return new Bi({dataSource:3,targetDoc:t.settings.targetDoc,methodName:r._methodName,arrayElement:e},t.databaseId,t.serializer,t.ignoreUndefinedProperties)}class Ha extends In{_toFieldTransform(t){return new gs(t.path,new Hn)}isEqual(t){return t instanceof Ha}}class Ja extends In{constructor(t,e){super(t),this.Sc=e}_toFieldTransform(t){const e=pf(this,t,!0),n=this.Sc.map((i=>En(i,e))),s=new ln(n);return new gs(t.path,s)}isEqual(t){return t instanceof Ja&&cs(this.Sc,t.Sc)}}class Ya extends In{constructor(t,e){super(t),this.Sc=e}_toFieldTransform(t){const e=pf(this,t,!0),n=this.Sc.map((i=>En(i,e))),s=new hn(n);return new gs(t.path,s)}isEqual(t){return t instanceof Ya&&cs(this.Sc,t.Sc)}}class Xa extends In{constructor(t,e){super(t),this.bc=e}_toFieldTransform(t){const e=new Jn(t.serializer,Uh(t.serializer,this.bc));return new gs(t.path,e)}isEqual(t){return t instanceof Xa&&this.bc===t.bc}}function Za(r,t,e,n){const s=r.I(1,t,e);eu("Data must be an object, but it was:",s,n);const i=[],a=vt.empty();qe(n,((c,h)=>{const f=nu(t,c,e);h=It(h);const m=s.fc(f);if(h instanceof Ts)i.push(f);else{const p=En(h,m);p!=null&&(i.push(f),a.set(f,p))}}));const u=new Ot(i);return new mf(a,u,s.fieldTransforms)}function tu(r,t,e,n,s,i){const a=r.I(1,t,e),u=[ce(t,n,e)],c=[s];if(i.length%2!=0)throw new b(P.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let p=0;p<i.length;p+=2)u.push(ce(t,i[p])),c.push(i[p+1]);const h=[],f=vt.empty();for(let p=u.length-1;p>=0;--p)if(!Tf(h,u[p])){const v=u[p];let C=c[p];C=It(C);const N=a.fc(v);if(C instanceof Ts)h.push(v);else{const D=En(C,N);D!=null&&(h.push(v),f.set(v,D))}}const m=new Ot(h);return new mf(f,m,a.fieldTransforms)}function _f(r,t,e,n=!1){return En(e,r.I(n?4:3,t))}function En(r,t){if(If(r=It(r)))return eu("Unsupported field value:",t,r),yf(r,t);if(r instanceof In)return(function(n,s){if(!gf(s.dataSource))throw s.yc(`${n._methodName}() can only be used with update() and set()`);if(!s.path)throw s.yc(`${n._methodName}() is not currently supported inside arrays`);const i=n._toFieldTransform(s);i&&s.fieldTransforms.push(i)})(r,t),null;if(r===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),r instanceof Array){if(t.settings.arrayElement&&t.dataSource!==4)throw t.yc("Nested arrays are not supported");return(function(n,s){const i=[];let a=0;for(const u of n){let c=En(u,s.gc(a));c==null&&(c={nullValue:"NULL_VALUE"}),i.push(c),a++}return{arrayValue:{values:i}}})(r,t)}return(function(n,s){if((n=It(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return Uh(s.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const i=Z.fromDate(n);return{timestampValue:Yn(s.serializer,i)}}if(n instanceof Z){const i=new Z(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Yn(s.serializer,i)}}if(n instanceof re)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Ut)return{bytesValue:td(s.serializer,n._byteString)};if(n instanceof nt){const i=s.databaseId,a=n.firestore._databaseId;if(!a.isEqual(i))throw s.yc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:Ta(n.firestore._databaseId||s.databaseId,n._key.path)}}if(n instanceof $t)return(function(a,u){const c=a instanceof $t?a.toArray():a;return{mapValue:{fields:{[ca]:{stringValue:la},[$n]:{arrayValue:{values:c.map((f=>{if(typeof f!="number")throw u.yc("VectorValues must only contain numeric values.");return ma(u.serializer,f)}))}}}}}})(n,s);if(hd(n))return n._toProto(s.serializer);throw s.yc(`Unsupported field value: ${Ti(n)}`)})(r,t)}function yf(r,t){const e={};return mh(r)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):qe(r,((n,s)=>{const i=En(s,t.dc(n));i!=null&&(e[n]=i)})),{mapValue:{fields:e}}}function If(r){return!(typeof r!="object"||r===null||r instanceof Array||r instanceof Date||r instanceof Z||r instanceof re||r instanceof Ut||r instanceof nt||r instanceof In||r instanceof $t||hd(r))}function eu(r,t,e){if(!If(e)||!Hl(e)){const n=Ti(e);throw n==="an object"?t.yc(r+" a custom object"):t.yc(r+" "+n)}}function ce(r,t,e){if((t=It(t))instanceof fr)return t._internalPath;if(typeof t=="string")return nu(r,t);throw Ii("Field path arguments must be of type string or ",r,!1,void 0,e)}const ny=new RegExp("[~\\*/\\[\\]]");function nu(r,t,e){if(t.search(ny)>=0)throw Ii(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,r,!1,void 0,e);try{return new fr(...t.split("."))._internalPath}catch{throw Ii(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r,!1,void 0,e)}}function Ii(r,t,e,n,s){const i=n&&!n.isEmpty(),a=s!==void 0;let u=`Function ${t}() called with invalid data`;e&&(u+=" (via `toFirestore()`)"),u+=". ";let c="";return(i||a)&&(c+=" (found",i&&(c+=` in field ${n}`),a&&(c+=` in document ${s}`),c+=")"),new b(P.INVALID_ARGUMENT,u+r+c)}function Tf(r,t){return r.some((e=>e.isEqual(t)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uy(){return new Ts("deleteField")}function jy(){return new Ha("serverTimestamp")}function zy(...r){return new Ja("arrayUnion",r)}function Gy(...r){return new Ya("arrayRemove",r)}function Ky(r){return new Xa("increment",r)}function $y(r){return new $t(r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qy(r){var n;const t=ht(Q(r.firestore,st)),e=(n=t._onlineComponents)==null?void 0:n.datastore.serializer;return e===void 0?null:xi(e,Dt(r._query)).ft}function Wy(r,t){var i;const e=fh(t,((a,u)=>new Wh(u,a.aggregateType,a._internalFieldPath))),n=ht(Q(r.firestore,st)),s=(i=n._onlineComponents)==null?void 0:i.datastore.serializer;return s===void 0?null:od(s,Dh(r._query),e,!0).request}const bl="@firebase/firestore",Cl="4.14.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(t="count",e){this._internalFieldPath=e,this.type="AggregateField",this.aggregateType=t}}class ry{constructor(t,e,n){this._userDataWriter=e,this._data=n,this.type="AggregateQuerySnapshot",this.query=t}data(){return this._userDataWriter.convertObjectMap(this._data)}_fieldsProto(){return new vt({mapValue:{fields:this._data}}).clone().value.mapValue.fields}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oI(r){return new as("sum",ce("sum",r))}function aI(r){return new as("avg",ce("average",r))}function iy(){return new as("count")}function uI(r,t){var e,n;return r instanceof as&&t instanceof as&&r.aggregateType===t.aggregateType&&((e=r._internalFieldPath)==null?void 0:e.canonicalString())===((n=t._internalFieldPath)==null?void 0:n.canonicalString())}function cI(r,t){return hf(r.query,t.query)&&cs(r.data(),t.data())}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lI(r){return oy(r,{count:iy()})}function oy(r,t){const e=Q(r.firestore,st),n=ht(e),s=fh(t,((i,a)=>new Wh(a,i.aggregateType,i._internalFieldPath)));return L_(n,r._query,s).then((i=>(function(u,c,h){const f=new je(u);return new ry(c,f,h)})(e,r,i)))}class ay{constructor(t){this.kind="memory",this._onlineComponentProvider=Me.provider,this._offlineComponentProvider=t!=null&&t.garbageCollector?t.garbageCollector._offlineComponentProvider:{build:()=>new Ka(void 0)}}toJSON(){return{kind:this.kind}}}class uy{constructor(t){let e;this.kind="persistent",t!=null&&t.tabManager?(t.tabManager._initialize(t),e=t.tabManager):(e=fy(void 0),e._initialize(t)),this._onlineComponentProvider=e._onlineComponentProvider,this._offlineComponentProvider=e._offlineComponentProvider}toJSON(){return{kind:this.kind}}}class cy{constructor(){this.kind="memoryEager",this._offlineComponentProvider=nr.provider}toJSON(){return{kind:this.kind}}}class ly{constructor(t){this.kind="memoryLru",this._offlineComponentProvider={build:()=>new Ka(t)}}toJSON(){return{kind:this.kind}}}function hI(){return new cy}function dI(r){return new ly(r==null?void 0:r.cacheSizeBytes)}function fI(r){return new ay(r)}function mI(r){return new uy(r)}class hy{constructor(t){this.forceOwnership=t,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new $a(e,t==null?void 0:t.cacheSizeBytes,this.forceOwnership)}}}class dy{constructor(){this.kind="PersistentMultipleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new ef(e,t==null?void 0:t.cacheSizeBytes)}}}function fy(r){return new hy(r==null?void 0:r.forceOwnership)}function gI(){return new dy}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zt._jsonSchemaVersion="firestore/querySnapshot/1.0",zt._jsonSchema={type:_t("string",zt._jsonSchemaVersion),bundleSource:_t("string","QuerySnapshot"),bundleName:_t("string"),bundle:_t("string")};const gy={maxAttempts:5};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yy extends _y{constructor(t,e){super(t,e),this._firestore=t}get(t){const e=Se(t,this._firestore),n=new je(this._firestore);return super.get(t).then((s=>new jt(this._firestore,n,e._key,s._document,new Pe(!1,!1),e.converter)))}}function II(r,t,e){r=Q(r,st);const n={...gy,...e};(function(a){if(a.maxAttempts<1)throw new b(P.INVALID_ARGUMENT,"Max attempts must be at least 1")})(n);const s=ht(r);return U_(s,(i=>t(new yy(r,i))),n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t);return of(e,r._key).then((n=>ou(t,r,n)))}function EI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return F_(e,r._key).then((s=>new jt(t,n,r._key,s,new Pe(s!==null&&s.hasLocalMutations,!0),r.converter)))}function wI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t);return of(e,r._key,{source:"server"}).then((n=>ou(t,r,n)))}function AI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return wf(r._query),af(e,r._query).then((s=>new zt(t,n,r,s)))}function vI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return O_(e,r._query).then((s=>new zt(t,n,r,s)))}function RI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return af(e,r._query,{source:"server"}).then((s=>new zt(t,n,r,s)))}function PI(r,t,e){r=Q(r,nt);const n=Q(r.firestore,st),s=Ki(r.converter,t,e),i=Tn(n);return As(n,[Ui(i,"setDoc",r._key,s,r.converter!==null,e).toMutation(r._key,lt.none())])}function SI(r,t,e,...n){r=Q(r,nt);const s=Q(r.firestore,st),i=Tn(s);let a;return a=typeof(t=It(t))=="string"||t instanceof fr?tu(i,"updateDoc",r._key,t,e,n):Za(i,"updateDoc",r._key,t),As(s,[a.toMutation(r._key,lt.exists(!0))])}function VI(r){return As(Q(r.firestore,st),[new ar(r._key,lt.none())])}function bI(r,t){const e=Q(r.firestore,st),n=J_(r),s=Ki(r.converter,t),i=Tn(r.firestore);return As(e,[Ui(i,"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,lt.exists(!1))]).then((()=>n))}function Nl(r,...t){var h,f,m;r=It(r);let e={includeMetadataChanges:!1,source:"default"},n=0;typeof t[n]!="object"||On(t[n])||(e=t[n++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(On(t[n])){const p=t[n];t[n]=(h=p.next)==null?void 0:h.bind(p),t[n+1]=(f=p.error)==null?void 0:f.bind(p),t[n+2]=(m=p.complete)==null?void 0:m.bind(p)}let i,a,u;if(r instanceof nt)a=Q(r.firestore,st),u=ir(r._key.path),i={next:p=>{t[n]&&t[n](ou(a,r,p))},error:t[n+1],complete:t[n+2]};else{const p=Q(r,Pt);a=Q(p.firestore,st),u=p._query;const v=new je(a);i={next:C=>{t[n]&&t[n](new zt(a,v,p,C))},error:t[n+1],complete:t[n+2]},wf(r._query)}const c=ht(a);return M_(c,u,s,i)}function CI(r,t,...e){const n=It(r),s=(function(c){const h={bundle:"",bundleName:"",bundleSource:""},f=["bundle","bundleName","bundleSource"];for(const m of f){if(!(m in c)){h.error=`snapshotJson missing required field: ${m}`;break}const p=c[m];if(typeof p!="string"){h.error=`snapshotJson field '${m}' must be a string.`;break}if(p.length===0){h.error=`snapshotJson field '${m}' cannot be an empty string.`;break}m==="bundle"?h.bundle=p:m==="bundleName"?h.bundleName=p:m==="bundleSource"&&(h.bundleSource=p)}return h})(t);if(s.error)throw new b(P.INVALID_ARGUMENT,s.error);let i,a=0;if(typeof e[a]!="object"||On(e[a])||(i=e[a++]),s.bundleSource==="QuerySnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return(function(h,f,m,p,v){let C,N=!1;return Vl(h,f.bundle).then((()=>X_(h,f.bundleName))).then((q=>{q&&!N&&(v&&q.withConverter(v),C=Nl(q,m||{},p))})).catch((q=>(p.error&&p.error(q),()=>{}))),()=>{N||(N=!0,C&&C())}})(n,s,i,u,e[a])}if(s.bundleSource==="DocumentSnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return(function(h,f,m,p,v){let C,N=!1;return Vl(h,f.bundle).then((()=>{if(!N){const q=new nt(h,v||null,k.fromPath(f.bundleName));C=Nl(q,m||{},p)}})).catch((q=>(p.error&&p.error(q),()=>{}))),()=>{N||(N=!0,C&&C())}})(n,s,i,u,e[a])}throw new b(P.INVALID_ARGUMENT,`unsupported bundle source: ${s.bundleSource}`)}function xI(r,t){r=Q(r,st);const e=ht(r),n=On(t)?t:{next:t};return B_(e,n)}function As(r,t){const e=ht(r);return q_(e,t)}function ou(r,t,e){const n=e.docs.get(t._key),s=new je(r);return new jt(r,s,t._key,n,new Pe(e.hasPendingWrites,e.fromCache),t.converter)}function DI(r){return r=Q(r,st),ht(r),new py(r,(t=>As(r,t)))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iy{constructor(t){this._firestore=t,this.type="PersistentCacheIndexManager"}}function kI(r){var s;r=Q(r,st);const t=Ml.get(r);if(t)return t;if(((s=ht(r)._uninitializedComponentsProvider)==null?void 0:s._offline.kind)!=="persistent")return null;const n=new Iy(r);return Ml.set(r,n),n}function MI(r){Sf(r,!0)}function FI(r){Sf(r,!1)}function OI(r){const t=ht(r._firestore);$_(t).then((e=>x("deleting all persistent cache indexes succeeded"))).catch((e=>Gt("deleting all persistent cache indexes failed",e)))}function Sf(r,t){const e=ht(r._firestore);K_(e,t).then((n=>x(`setting persistent cache index auto creation isEnabled=${t} succeeded`))).catch((n=>Gt(`setting persistent cache index auto creation isEnabled=${t} failed`,n)))}const Ml=new WeakMap;/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LI{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(t){return au.instance.onExistenceFilterMismatch(t)}}class au{constructor(){this.t=new Map}static get instance(){return $s||($s=new au,Og($s)),$s}o(t){this.t.forEach((e=>e(t)))}onExistenceFilterMismatch(t){const e=Symbol(),n=this.t;return n.set(e,t),()=>n.delete(e)}}let $s=null;(function(t,e=!0){ym(_m),gm(new pm("firestore",((n,{instanceIdentifier:s,options:i})=>{const a=n.getProvider("app").getImmediate(),u=new st(new Em(n.getProvider("auth-internal")),new vm(a,n.getProvider("app-check-internal")),lg(a,s),a);return i={useFetchStreams:e,...i},u._setSettings(i),u}),"PUBLIC").setMultipleInstances(!0)),cc(bl,Cl,t),cc(bl,Cl,"esm2020")})();export{Ef as AbstractUserDataWriter,as as AggregateField,ry as AggregateQuerySnapshot,Ut as Bytes,Cy as CACHE_SIZE_UNLIMITED,ne as CollectionReference,nt as DocumentReference,jt as DocumentSnapshot,fr as FieldPath,In as FieldValue,st as Firestore,b as FirestoreError,re as GeoPoint,Y_ as LoadBundleTask,Iy as PersistentCacheIndexManager,Pt as Query,mr as QueryCompositeFilterConstraint,Es as QueryConstraint,ri as QueryDocumentSnapshot,Gi as QueryEndAtConstraint,ws as QueryFieldFilterConstraint,ji as QueryLimitConstraint,su as QueryOrderByConstraint,zt as QuerySnapshot,zi as QueryStartAtConstraint,Pe as SnapshotMetadata,Z as Timestamp,yy as Transaction,$t as VectorValue,py as WriteBatch,ea as _AutoId,ft as _ByteString,an as _DatabaseId,k as _DocumentKey,Ay as _EmptyAppCheckTokenProvider,Im as _EmptyAuthCredentialsProvider,ct as _FieldPath,LI as _TestingHooks,Q as _cast,wy as _debugAssert,Wy as _internalAggregationQueryToProtoRunAggregationQueryRequest,Qy as _internalQueryToProtoQueryTarget,Ry as _isBase64Available,Gt as _logWarn,bm as _validateIsNotUsedTogether,bI as addDoc,uI as aggregateFieldEqual,cI as aggregateQuerySnapshotEqual,Xy as and,Gy as arrayRemove,zy as arrayUnion,aI as average,My as clearIndexedDbPersistence,Sy as collection,Vy as collectionGroup,H_ as connectFirestoreEmulator,iy as count,OI as deleteAllPersistentCacheIndexes,VI as deleteDoc,Uy as deleteField,Ly as disableNetwork,FI as disablePersistentCacheIndexAutoCreation,J_ as doc,By as documentId,pI as documentSnapshotFromJSON,Ny as enableIndexedDbPersistence,ky as enableMultiTabIndexedDbPersistence,Oy as enableNetwork,MI as enablePersistentCacheIndexAutoCreation,iI as endAt,sI as endBefore,ht as ensureFirestoreConfigured,As as executeWrite,oy as getAggregateFromServer,lI as getCountFromServer,TI as getDoc,EI as getDocFromCache,wI as getDocFromServer,AI as getDocs,vI as getDocsFromCache,RI as getDocsFromServer,Dy as getFirestore,kI as getPersistentCacheIndexManager,Ky as increment,xy as initializeFirestore,tI as limit,eI as limitToLast,Vl as loadBundle,hI as memoryEagerGarbageCollector,fI as memoryLocalCache,dI as memoryLruGarbageCollector,X_ as namedQuery,Nl as onSnapshot,CI as onSnapshotResume,xI as onSnapshotsInSync,Yy as or,Zy as orderBy,mI as persistentLocalCache,gI as persistentMultipleTabManager,fy as persistentSingleTabManager,Hy as query,hf as queryEqual,_I as querySnapshotFromJSON,by as refEqual,II as runTransaction,jy as serverTimestamp,PI as setDoc,NI as setIndexConfiguration,Ey as setLogLevel,yI as snapshotEqual,rI as startAfter,nI as startAt,oI as sum,qy as terminate,SI as updateDoc,$y as vector,Fy as waitForPendingWrites,Jy as where,DI as writeBatch};
