    ...
    return (
         <div className="text-black font-sans leading-tight">
            ...
            <div className="A4-page bg-white shadow-lg p-6 flex flex-col text-sm my-4">
                 <header className="text-center mb-4"><h1 className="text-xl font-bold">HOLISTIC PROGRESS CARD (HPC) - PREPARATORY STAGE</h1><p className="text-md">Academic Year: {hpcData.academicYear}</p></header>
            ...
            <div className="A4-page bg-white shadow-lg p-6 flex flex-col text-sm my-4">
                 ...
                 <div className="space-y-4">
                    {['Language Education (R1)', 'Language Education (R2)', 'Mathematics', 'The World Around Us', 'Art Education', 'Physical Education', 'Overall'].map(standard => (
                        <div key={standard} className="grid grid-cols-4 gap-2 items-center border p-1 rounded-md">
                            <h3 className="font-bold col-span-1">{standard}</h3>
