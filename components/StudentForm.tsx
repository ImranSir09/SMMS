...
export const StudentForm: React.FC<StudentFormProps> = ({ studentToEdit, onSave, onClose }) => {
    ...
    // Helper to dynamically get input class based on error state
    const getInputClass = (fieldName: string) => {
        const baseClass = "p-3 w-full bg-background border rounded-md focus:outline-none focus:ring-2 text-sm transition-colors";
            ...
            <div className="p-4 space-y-4 flex-1 overflow-y-auto">
                <div className="grid grid-cols-2 gap-4">
                   <div className="col-span-2">
                       <label htmlFor="name" className={labelStyle}>Name <span className="text-red-500">*</span></label>
                       <input id="name" name="name" value={formData.name || ''} onChange={handleChange} className={getInputClass('name')} placeholder="Student Full Name" />
                       {errors.name && <p className="text-red-500 text-xs mt-1">{errors.name}</p>}
                   </div>
                    <div>
                        <label htmlFor="rollNo" className={labelStyle}>Roll No <span className="text-red-500">*</span></label>
                        <input id="rollNo" name="rollNo" type="text" inputMode="numeric" value={formData.rollNo || ''} onChange={handleChange} className={getInputClass('rollNo')} />
                        {errors.rollNo && <p className="text-red-500 text-xs mt-1">{errors.rollNo}</p>}
                    </div>
                    <div>
                        <label htmlFor="admissionNo" className={labelStyle}>Admission No <span className="text-red-500">*</span></label>
                        <input id="admissionNo" name="admissionNo" type="text" inputMode="numeric" value={formData.admissionNo || ''} onChange={handleChange} className={getInputClass('admissionNo')} />
                        {errors.admissionNo && <p className="text-red-500 text-xs mt-1">{errors.admissionNo}</p>}
                    </div>
                    <div>
                        <label htmlFor="dob" className={labelStyle}>D.O.B <span className="text-red-500">*</span></label>
                        <input id="dob" name="dob" type="date" value={formData.dob || ''} onChange={handleChange} className={getInputClass('dob')} />
                        {errors.dob && <p className="text-red-500 text-xs mt-1">{errors.dob}</p>}
                    </div>
                    <div>
                        <label htmlFor="gender" className={labelStyle}>Gender</label>
                        <select id="gender" name="gender" value={formData.gender || 'Male'} onChange={handleChange} className={getInputClass('gender')}>
                            <option>Male</option><option>Female</option><option>Other</option>
                        </select>
                    </div>
                    <div>
                        <label htmlFor="className" className={labelStyle}>Class <span className="text-red-500">*</span></label>
                       <select id="className" name="className" value={formData.className || ''} onChange={handleChange} className={getInputClass('className')}>
                   ...
                   <div>
                       <label htmlFor="section" className={labelStyle}>Section <span className="text-red-500">*</span></label>
                       <input id="section" name="section" value={formData.section || ''} onChange={handleChange} className={getInputClass('section')} />
                       {errors.section && <p className="text-red-500 text-xs mt-1">{errors.section}</p>}
                   </div>
                   <div className="col-span-2">
                       <label htmlFor="fathersName" className={labelStyle}>Father's Name <span className="text-red-500">*</span></label>
                       <input id="fathersName" name="fathersName" value={formData.fathersName || ''} onChange={handleChange} className={getInputClass('fathersName')} />
                       {errors.fathersName && <p className="text-red-500 text-xs mt-1">{errors.fathersName}</p>}
                   </div>
                   <div className="col-span-2">
                       <label htmlFor="mothersName" className={labelStyle}>Mother's Name <span className="text-red-500">*</span></label>
                       <input id="mothersName" name="mothersName" value={formData.mothersName || ''} onChange={handleChange} className={getInputClass('mothersName')} />
                       {errors.mothersName && <p className="text-red-500 text-xs mt-1">{errors.mothersName}</p>}
                   </div>
                   <div className="col-span-2">
                       <label htmlFor="contact" className={labelStyle}>Contact <span className="text-red-500">*</span></label>
                       <input id="contact" name="contact" type="tel" value={formData.contact || ''} onChange={handleChange} className={getInputClass('contact')} placeholder="10 Digit Mobile Number" />
                       {errors.contact && <p className="text-red-500 text-xs mt-1">{errors.contact}</p>}
                   </div>
                   <div className="col-span-2">
                       <label htmlFor="address" className={labelStyle}>Address <span className="text-red-500">*</span></label>
                       <input id="address" name="address" value={formData.address || ''} onChange={handleChange} className={getInputClass('address')} />
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                    <div>
                        ...
                        <input id="admissionDate" name="admissionDate" type="date" value={formData.admissionDate || ''} onChange={handleChange} className={getInputClass('admissionDate')} />
                    </div>
                    <div>
                        <label htmlFor="category" className={labelStyle}>Category</label>
                        <select id="category" name="category" value={formData.category || ''} onChange={handleChange} className={getInputClass('category')}>
                           <option value="">-- Select --</option>
                    ...
                    <div>
                        ...
                        <select id="bloodGroup" name="bloodGroup" value={formData.bloodGroup || ''} onChange={handleChange} className={getInputClass('bloodGroup')}>
                           <option value="">-- Select --</option>
                    ...
                    <div className="col-span-2">
                        ...
                        <input id="aadharNo" name="aadharNo" type="tel" value={formData.aadharNo || ''} onChange={handleChange} className={getInputClass('aadharNo')} placeholder="12-digit Aadhar Number" />
                    ...
                    <div className="col-span-2">
                        ...
                        <input id="accountNo" name="accountNo" type="text" inputMode="numeric" value={formData.accountNo || ''} onChange={handleChange} className={getInputClass('accountNo')} placeholder="Bank Account Number" />
                    ...
                    <div className="col-span-2">
                        ...
                        <input id="ifscCode" name="ifscCode" type="text" autoCapitalize="characters" value={formData.ifscCode || ''} onChange={handleChange} className={`${getInputClass('ifscCode')} uppercase`} placeholder="Bank IFSC Code" />
